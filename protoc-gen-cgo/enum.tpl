...
//#include <stdlib.h>
//#include <assert.h>
//#include "{{underscoreToDash .CstructName}}.h" //ToDo: change name of the C-file
import "C"
import (
    "fmt"
...
func new{{.MessageName}}({{lowCaseFirstLetter .MessageName}} *{{.ProtoFileName}}.{{.MessageName}}) (*C.{{dashToUnderscore .CstructName}}_t, error) { //ToDo: change name of C-struct
    ...
    switch {{lowCaseFirstLetter .MessageName}} { {{with .FieldList}}{{ range . }}
            case {{.ProtoFileName}}.{{.FieldName}}:
                ret = C.{{tolow .CstructLeafName}} {{ end }}{{end}} //ToDo: change name of C-variable
    default:
