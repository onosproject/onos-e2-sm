...
func (m *reportModule) Execute(targets map[string]pgs.File, pkgs map[string]pgs.Package) []pgs.Artifact {
	...
	for _, f := range targets { // Input .proto files
		...
		// ToDo: implement template for Enums
		for i, enum := range f.AllEnums() { // Constants
			fmt.Fprintf(buf, "%03d. %v\n Enum Name", i, enum.Name())
			fmt.Fprintf(buf, "%03d. %v\n Enum Descriptor", i, enum.Descriptor())
		}
		...
		for i, msg := range f.AllMessages() { // Messages in each of .proto files
			...
			for _, fld := range flds {
				dataMsg.CstructName = fld.GetJsonName()
				...
				//fmt.Fprintf(buf, "%03d. Field GetJsonName() -- %v\n ", i, UnderscoreToDash(DashToUnderscore(fld.GetJsonName())))
				...
				//fmt.Fprintf(buf, "%03d. Field GetNumber() -- %v\n ", i, fld.GetNumber())
				//fmt.Fprintf(buf, "%03d. Field GetLabel() -- %v\n ", i, fld.GetLabel())
			}
			...
			//fmt.Fprintf(buf, "%03d. Message AllMessages() -- %v\n ", i, msg.AllMessages())
			//fmt.Fprintf(buf, "%03d. Message Dependents() -- %v\n ", i, msg.Dependents())
			//fmt.Fprintf(buf, "%03d. Message Extensions() -- %v\n ", i, msg.Extensions())
			//fmt.Fprintf(buf, "%03d. Message AllEnums() -- %v\n ", i, msg.AllEnums())
			//fmt.Fprintf(buf, "%03d. Message DefinedExtensions() -- %v\n ", i, msg.DefinedExtensions())
			fmt.Fprintf(buf, "%03d. Message FullyQualifiedName() -- %v\n ", i, msg.FullyQualifiedName())
			//fmt.Fprintf(buf, "%03d. Message Imports() -- %v\n ", i, msg.Imports())
			//fmt.Fprintf(buf, "%03d. Message IsMapEntry() -- %v\n ", i, msg.IsMapEntry())
			//fmt.Fprintf(buf, "%03d. Message IsWellKnown() -- %v\n ", i, msg.IsWellKnown())
			//fmt.Fprintf(buf, "%03d. Message MapEntries() -- %v\n ", i, msg.MapEntries())
			//fmt.Fprintf(buf, "%03d. Message Messages() -- %v\n ", i, msg.Messages())
			//fmt.Fprintf(buf, "%03d. Message Package().Files() -- %v\n ", i, msg.Package().Files())
