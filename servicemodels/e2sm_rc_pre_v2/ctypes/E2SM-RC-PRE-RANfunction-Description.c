...
static asn_TYPE_member_t asn_MBR_e2SM_RC_PRE_RANfunction_Item_3[] = {
	{ ATF_POINTER, 2, offsetof(struct e2SM_RC_PRE_RANfunction_Item, ric_EventTriggerStyle_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct e2SM_RC_PRE_RANfunction_Item, ric_ReportStyle_List),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_e2SM_RC_PRE_RANfunction_Item_specs_3 = {
	sizeof(struct e2SM_RC_PRE_RANfunction_Item),
	offsetof(struct e2SM_RC_PRE_RANfunction_Item, _asn_ctx),
