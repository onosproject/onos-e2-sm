...
func CreateE2SmRcPreControlOutcome(RANparameterID int32, RANparameterValue int32) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcome, error) {
	...
	outcomeElementList := &e2sm_rc_pre_v2.RanparameterItem{
		...
		RanParameterValue: &e2sm_rc_pre_v2.RanparameterValue{
