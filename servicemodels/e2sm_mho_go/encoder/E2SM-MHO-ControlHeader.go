...
func PerEncodeE2SmMhoControlHeader(ch *e2smmhov2.E2SmMhoControlHeader) ([]byte, error) {
	...
	per, err := aper.MarshalWithParams(ch, "choiceExt", e2smmhov2.MhoChoicemap, nil)
	if err != nil {
		return nil, err
	}
...
func PerDecodeE2SmMhoControlHeader(per []byte) (*e2smmhov2.E2SmMhoControlHeader, error) {

	log.Debugf("Obtained E2SM-RC-PRE-ControlHeader PER bytes are\n%v", hex.Dump(per))

	result := e2smmhov2.E2SmMhoControlHeader{}
