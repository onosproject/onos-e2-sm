...
func createRanFunctionName() *e2smkpmv2.RanfunctionName {

	var rfi int32 = 21
	return &e2smkpmv2.RanfunctionName{
...
func createRanFunctionNameNoOptional() *e2smkpmv2.RanfunctionName {
...
func Test_perEncodingRanFunctionName(t *testing.T) {
	...
	per, err := aper.MarshalWithParams(rfn, "valueExt", e2smkpmv2.Choicemape2smKpm, nil)
	assert.NilError(t, err)
	t.Logf("RanFunctionName PER\n%v", hex.Dump(per))

	result := e2smkpmv2.RanfunctionName{}
