...
func createActionDefinitionFormat1() (*e2smkpmv2.E2SmKpmActionDefinitionFormat1, error) {
...
func Test_perEncodingE2SmKpmActionDefinitionFormat1(t *testing.T) {
	...
	per, err := aper.MarshalWithParams(actionDefFormat1, "valueExt", e2smkpmv2.Choicemape2smKpm, nil)
	assert.NilError(t, err)
	t.Logf("E2SM-KPM-ActionDefinition-Format1 PER\n%v", hex.Dump(per))

	result := e2smkpmv2.E2SmKpmActionDefinitionFormat1{}
