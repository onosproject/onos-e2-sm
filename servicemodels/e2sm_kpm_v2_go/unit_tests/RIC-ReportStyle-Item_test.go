...
func createRicReportStyleItem() (*e2smkpmv2.RicReportStyleItem, error) {

	measInfo := &e2smkpmv2.MeasurementInfoActionList{
	...
	res := e2smkpmv2.RicReportStyleItem{
...
func Test_perEncodingRicReportStyleItem(t *testing.T) {
	...
	result := e2smkpmv2.RicReportStyleItem{}
