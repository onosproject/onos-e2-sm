...
func createActionDefinitionFormat2() (*e2smkpmv2.E2SmKpmActionDefinitionFormat2, error) {
...
func Test_perEncodingE2SmKpmActionDefinitionFormat2(t *testing.T) {
	...
	per, err := aper.MarshalWithParams(actionDefFormat2, "valueExt", e2smkpmv2.Choicemape2smKpm, nil)
	assert.NilError(t, err)
	t.Logf("E2SM-KPM-ActionDefinition-Format2 PER\n%v", hex.Dump(per))

	result := e2smkpmv2.E2SmKpmActionDefinitionFormat2{}
