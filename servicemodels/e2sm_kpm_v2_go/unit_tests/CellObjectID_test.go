...
func createCellObjectID0() *e2smkpmv2.CellObjectId {

	return &e2smkpmv2.CellObjectId{
		Value: "",
	}
}

func createCellObjectID1() *e2smkpmv2.CellObjectId {
...
func createCellObjectID2() *e2smkpmv2.CellObjectId {
...
func Test_perEncodingCellObjectID0(t *testing.T) {
	...
	per, err := aper.MarshalWithParams(coID, "", e2smkpmv2.Choicemape2smKpm, nil)
	assert.NilError(t, err)
	t.Logf("CellObjectID PER\n%v", hex.Dump(per))

	result := e2smkpmv2.CellObjectId{}
