...
func (m *MeasurementLabel) validate(all bool) error {
	...
	if m.BitrateRange != nil {
		// no validation rules for BitrateRange
	}

	if m.LayerMuMimo != nil {
	...
	if m.PreLabelOverride != nil {
		// no validation rules for PreLabelOverride
	}

	if m.StartEndInd != nil {
...
func (m *ActionDefinitionFormats) validate(all bool) error {
	...
	case *ActionDefinitionFormats_ActionDefinitionFormat2:
	...
	case *ActionDefinitionFormats_ActionDefinitionFormat3:
