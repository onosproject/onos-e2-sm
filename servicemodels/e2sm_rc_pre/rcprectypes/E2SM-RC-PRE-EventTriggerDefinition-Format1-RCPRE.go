...
func XerEncodeE2SmRcPreEventTriggerDefinitionFormat1(E2SmRcPreEventTriggerDefinitionFormat1 *e2sm_rc_pre_v2.E2SmRcPreEventTriggerDefinitionFormat1) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE, unsafe.Pointer(E2SmRcPreEventTriggerDefinitionFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("XerEncodeE2SmRcPreEventTriggerDefinitionFormat1() %s", err.Error())
	}
	return bytes, nil
...
func PerEncodeE2SmRcPreEventTriggerDefinitionFormat1(E2SmRcPreEventTriggerDefinitionFormat1 *e2sm_rc_pre_v2.E2SmRcPreEventTriggerDefinitionFormat1) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE, unsafe.Pointer(E2SmRcPreEventTriggerDefinitionFormat1CP))
	if err != nil {
...
func XerDecodeE2SmRcPreEventTriggerDefinitionFormat1(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreEventTriggerDefinitionFormat1, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmRcPreEventTriggerDefinitionFormat1((*C.E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE_t)(unsafePtr))
}
...
func PerDecodeE2SmRcPreEventTriggerDefinitionFormat1(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreEventTriggerDefinitionFormat1, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmRcPreEventTriggerDefinitionFormat1(e2SmRcPreEventTriggerDefinitionFormat1 *e2sm_rc_pre_v2.E2SmRcPreEventTriggerDefinitionFormat1) (*C.E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE_t, error) {
	...
	e2SmRcPreEventTriggerDefinitionFormat1C := C.E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE_t{
...
func decodeE2SmRcPreEventTriggerDefinitionFormat1(e2SmRcPreEventTriggerDefinitionFormat1C *C.E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE_t) (*e2sm_rc_pre_v2.E2SmRcPreEventTriggerDefinitionFormat1, error) {
...
func decodeE2SmRcPreEventTriggerDefinitionFormat1Bytes(array [8]byte) (*e2sm_rc_pre_v2.E2SmRcPreEventTriggerDefinitionFormat1, error) {
	e2SmRcPreEventTriggerDefinitionFormat1C := (*C.E2SM_RC_PRE_EventTriggerDefinition_Format1_RCPRE_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
