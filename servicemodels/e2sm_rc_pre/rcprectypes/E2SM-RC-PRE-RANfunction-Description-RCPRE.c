...
static asn_TYPE_member_t asn_MBR_ric_EventTriggerStyle_List_4[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_RIC_EventTriggerStyle_List_RCPRE,
		0,
		{ 0, 0, 0 },
...
static asn_SET_OF_specifics_t asn_SPC_ric_EventTriggerStyle_List_specs_4 = {
	sizeof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item__ric_EventTriggerStyle_List),
	offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item__ric_EventTriggerStyle_List, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ric_ReportStyle_List_6[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RIC_ReportStyle_List_RCPRE,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		""
...
static asn_SET_OF_specifics_t asn_SPC_ric_ReportStyle_List_specs_6 = {
	sizeof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item__ric_ReportStyle_List),
	offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item__ric_ReportStyle_List, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_member_t asn_MBR_e2SM_RC_PRE_RANfunction_Item_3[] = {
	{ ATF_POINTER, 2, offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item, ric_EventTriggerStyle_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item, ric_ReportStyle_List),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_e2SM_RC_PRE_RANfunction_Item_specs_3 = {
	sizeof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item),
	offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE__e2SM_RC_PRE_RANfunction_Item, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_E2SM_RC_PRE_RANfunction_Description_RCPRE_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE, ranFunction_Name),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANfunction_Name_RCPRE,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ranFunction-Name"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE, e2SM_RC_PRE_RANfunction_Item),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E2SM_RC_PRE_RANfunction_Description_RCPRE_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ranFunction-Name */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* e2SM-RC-PRE-RANfunction-Item */
};
static asn_SEQUENCE_specifics_t asn_SPC_E2SM_RC_PRE_RANfunction_Description_RCPRE_specs_1 = {
	sizeof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE),
	offsetof(struct E2SM_RC_PRE_RANfunction_Description_RCPRE, _asn_ctx),
	asn_MAP_E2SM_RC_PRE_RANfunction_Description_RCPRE_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	2,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE = {
	"E2SM-RC-PRE-RANfunction-Description-RCPRE",
	"E2SM-RC-PRE-RANfunction-Description-RCPRE",
	&asn_OP_SEQUENCE,
	asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE_tags_1,
	sizeof(asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE_tags_1)
		/sizeof(asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE_tags_1[0]), /* 1 */
	asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE_tags_1,	/* Same as above */
	sizeof(asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE_tags_1)
		/sizeof(asn_DEF_E2SM_RC_PRE_RANfunction_Description_RCPRE_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_E2SM_RC_PRE_RANfunction_Description_RCPRE_1,
	2,	/* Elements count */
	&asn_SPC_E2SM_RC_PRE_RANfunction_Description_RCPRE_specs_1	/* Additional specs */
};
