...
func xerEncodeNRARFCN(nrarfcn *e2sm_rc_pre_v2.Nrarfcn) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_NRARFCN_RCPRE, unsafe.Pointer(nrarfcnCP))
	if err != nil {
...
func perEncodeNRARFCN(nrarfcn *e2sm_rc_pre_v2.Nrarfcn) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_NRARFCN_RCPRE, unsafe.Pointer(nrarfcnCP))
	if err != nil {
...
func xerDecodeNRARFCN(bytes []byte) (*e2sm_rc_pre_v2.Nrarfcn, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_NRARFCN_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeNRARFCN((*C.NRARFCN_RCPRE_t)(unsafePtr)), nil
}

func perDecodeNRARFCN(bytes []byte) (*e2sm_rc_pre_v2.Nrarfcn, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_NRARFCN_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newNRARFCN(nrarfcn *e2sm_rc_pre_v2.Nrarfcn) *C.NRARFCN_RCPRE_t {
	nrarfcnC := C.long(nrarfcn.Value)
	return &nrarfcnC
}

func decodeNRARFCN(nrarfcnC *C.NRARFCN_RCPRE_t) *e2sm_rc_pre_v2.Nrarfcn {
...
func decodeNRARFCNBytes(array [8]byte) *e2sm_rc_pre_v2.Nrarfcn {
	nrarfcnC := (C.NRARFCN_RCPRE_t)(binary.LittleEndian.Uint32(array[0:4]))
