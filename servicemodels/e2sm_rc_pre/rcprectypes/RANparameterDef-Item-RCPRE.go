...
//	}
//
//	bytes, err := encodeXer(&C.asn_DEF_RANparameterDef_Item_RCPRE, unsafe.Pointer(ranparameterDefItemCP))
//	if err != nil {
//		return nil, fmt.Errorf("xerEncodeRanparameterDefItem() %s", err.Error())
//	}
//	return bytes, nil
...
//	}
//
//	bytes, err := encodePerBuffer(&C.asn_DEF_RANparameterDef_Item_RCPRE, unsafe.Pointer(ranparameterDefItemCP))
//	if err != nil {
...
//	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RANparameterDef_Item_RCPRE)
//	if err != nil {
//		return nil, err
//	}
//	if unsafePtr == nil {
...
//	}
//	return decodeRanparameterDefItem((*C.RANparameterDef_Item_RCPRE_t)(unsafePtr))
//}
//
//func perDecodeRanparameterDefItem(bytes []byte) (*e2sm_rc_pre_v2.RanparameterDefItem, error) {
//	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RANparameterDef_Item_RCPRE)
//	if err != nil {
//		return nil, err
//	}
//	if unsafePtr == nil {
...
func newRanparameterDefItem(ranparameterDefItem *e2sm_rc_pre_v2.RanparameterDefItem) (*C.RANparameterDef_Item_RCPRE_t, error) {
	...
	ranparameterDefItemC := C.RANparameterDef_Item_RCPRE_t{
...
func decodeRanparameterDefItem(ranparameterDefItemC *C.RANparameterDef_Item_RCPRE_t) (*e2sm_rc_pre_v2.RanparameterDefItem, error) {
