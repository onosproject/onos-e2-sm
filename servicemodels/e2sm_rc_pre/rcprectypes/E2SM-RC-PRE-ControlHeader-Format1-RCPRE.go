...
func XerEncodeE2SmRcPreControlHeaderFormat1(e2SmRcPreControlHeaderFormat1 *e2sm_rc_pre_v2.E2SmRcPreControlHeaderFormat1) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_RC_PRE_ControlHeader_Format1_RCPRE, unsafe.Pointer(e2SmRcPreControlHeaderFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("XerEncodeE2SmRcPreControlHeaderFormat1() %s", err.Error())
	}
	return bytes, nil
...
func PerEncodeE2SmRcPreControlHeaderFormat1(e2SmRcPreControlHeaderFormat1 *e2sm_rc_pre_v2.E2SmRcPreControlHeaderFormat1) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_RC_PRE_ControlHeader_Format1_RCPRE, unsafe.Pointer(e2SmRcPreControlHeaderFormat1CP))
	if err != nil {
...
func XerDecodeE2SmRcPreControlHeaderFormat1(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreControlHeaderFormat1, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_RC_PRE_ControlHeader_Format1_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmRcPreControlHeaderFormat1((*C.E2SM_RC_PRE_ControlHeader_Format1_RCPRE_t)(unsafePtr))
}

func PerDecodeE2SmRcPreControlHeaderFormat1(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreControlHeaderFormat1, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_RC_PRE_ControlHeader_Format1_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmRcPreControlHeaderFormat1(e2SmRcPreControlHeaderFormat1 *e2sm_rc_pre_v2.E2SmRcPreControlHeaderFormat1) (*C.E2SM_RC_PRE_ControlHeader_Format1_RCPRE_t, error) {
	...
	e2SmRcPreControlHeaderFormat1C := C.E2SM_RC_PRE_ControlHeader_Format1_RCPRE_t{
		//cgi:                          cgi,
...
func decodeE2SmRcPreControlHeaderFormat1(e2SmRcPreControlHeaderFormat1C *C.E2SM_RC_PRE_ControlHeader_Format1_RCPRE_t) (*e2sm_rc_pre_v2.E2SmRcPreControlHeaderFormat1, error) {
...
func decodeE2SmRcPreControlHeaderFormat1Bytes(array [8]byte) (*e2sm_rc_pre_v2.E2SmRcPreControlHeaderFormat1, error) {
	controlHeaderFormat1C := (*C.E2SM_RC_PRE_ControlHeader_Format1_RCPRE_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
