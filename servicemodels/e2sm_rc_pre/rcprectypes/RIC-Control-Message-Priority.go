...
func newRicControlMessagePriority(ricControlMessagePriority *e2sm_rc_pre_v2.RicControlMessagePriority) (*C.RIC_Control_Message_Priority_t, error) {
...
func decodeRicControlMessagePriority(ricControlMessagePriorityC *C.RIC_Control_Message_Priority_t) (*e2sm_rc_pre_v2.RicControlMessagePriority, error) {
