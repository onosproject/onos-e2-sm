...
func newRanparameterItem(ranparameterItem *e2sm_rc_pre_v2.RanparameterItem) (*C.RANparameter_Item_t, error) {
...
func decodeRanparameterItem(ranparameterItemC *C.RANparameter_Item_t) (*e2sm_rc_pre_v2.RanparameterItem, error) {
