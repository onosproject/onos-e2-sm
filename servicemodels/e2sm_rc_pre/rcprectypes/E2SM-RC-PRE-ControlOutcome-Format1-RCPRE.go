...
//#include <stdlib.h>
//#include <assert.h>
//#include "E2SM-RC-PRE-ControlOutcome-Format1-RCPRE.h"
...
func XerEncodeE2SmRcPreControlOutcomeFormat1(e2SmRcPreControlOutcomeFormat1 *e2sm_rc_pre_v2.E2SmRcPreControlOutcomeFormat1) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_RC_PRE_ControlOutcome_Format1_RCPRE, unsafe.Pointer(e2SmRcPreControlOutcomeFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("XerEncodeE2SmRcPreControlOutcomeFormat1() %s", err.Error())
	}
	return bytes, nil
...
func PerEncodeE2SmRcPreControlOutcomeFormat1(e2SmRcPreControlOutcomeFormat1 *e2sm_rc_pre_v2.E2SmRcPreControlOutcomeFormat1) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_RC_PRE_ControlOutcome_Format1_RCPRE, unsafe.Pointer(e2SmRcPreControlOutcomeFormat1CP))
	if err != nil {
...
func XerDecodeE2SmRcPreControlOutcomeFormat1(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcomeFormat1, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_RC_PRE_ControlOutcome_Format1_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmRcPreControlOutcomeFormat1((*C.E2SM_RC_PRE_ControlOutcome_Format1_RCPRE_t)(unsafePtr))
}

func PerDecodeE2SmRcPreControlOutcomeFormat1(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcomeFormat1, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_RC_PRE_ControlOutcome_Format1_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmRcPreControlOutcomeFormat1(e2SmRcPreControlOutcomeFormat1 *e2sm_rc_pre_v2.E2SmRcPreControlOutcomeFormat1) (*C.E2SM_RC_PRE_ControlOutcome_Format1_RCPRE_t, error) {

	outcomeElementListC := new(C.struct_E2SM_RC_PRE_ControlOutcome_Format1_RCPRE__outcomeElement_List)
	e2SmRcPreControlOutcomeFormat1C := C.E2SM_RC_PRE_ControlOutcome_Format1_RCPRE_t{
...
func decodeE2SmRcPreControlOutcomeFormat1(e2SmRcPreControlOutcomeFormat1C *C.E2SM_RC_PRE_ControlOutcome_Format1_RCPRE_t) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcomeFormat1, error) {
	...
	for i := 0; i < ieCount; i++ {
		...
		ieC := *(**C.RANparameter_Item_RCPRE_t)(unsafe.Pointer(uintptr(unsafe.Pointer(e2SmRcPreControlOutcomeFormat1C.outcomeElement_List.list.array)) + offset))
...
func decodeE2SmRcPreControlOutcomeFormat1Bytes(array [8]byte) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcomeFormat1, error) {
	e2SmRcPreControlOutcomeFormat1C := (*C.E2SM_RC_PRE_ControlOutcome_Format1_RCPRE_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
