...
func xerDecodeBitString(bytes []byte) (*e2sm_rc_pre_v2.BitString, error) {
...
func perDecodeBitString(bytes []byte) (*e2sm_rc_pre_v2.BitString, error) {
...
//func newBitString(bs *e2sm_rc_pre_v2.BitString) (*C.BIT_STRING_t, error) {
