...
//#include <stdlib.h>
//#include <assert.h>
//#include "E2SM-RC-PRE-ControlOutcome-RCPRE.h"
import "C"
...
func XerEncodeE2SmRcPreControlOutcome(e2SmRcPreControlOutcome *e2sm_rc_pre_v2.E2SmRcPreControlOutcome) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_RC_PRE_ControlOutcome_RCPRE, unsafe.Pointer(e2SmRcPreControlOutcomeCP))
	if err != nil {
		return nil, fmt.Errorf("XerEncodeE2SmRcPreControlOutcome() %s", err.Error())
	}
	return bytes, nil
...
func PerEncodeE2SmRcPreControlOutcome(e2SmRcPreControlOutcome *e2sm_rc_pre_v2.E2SmRcPreControlOutcome) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_RC_PRE_ControlOutcome_RCPRE, unsafe.Pointer(e2SmRcPreControlOutcomeCP))
	if err != nil {
...
func XerDecodeE2SmRcPreControlOutcome(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcome, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_RC_PRE_ControlOutcome_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmRcPreControlOutcome((*C.E2SM_RC_PRE_ControlOutcome_RCPRE_t)(unsafePtr))
}

func PerDecodeE2SmRcPreControlOutcome(bytes []byte) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcome, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_RC_PRE_ControlOutcome_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmRcPreControlOutcome(e2SmRcPreControlOutcome *e2sm_rc_pre_v2.E2SmRcPreControlOutcome) (*C.E2SM_RC_PRE_ControlOutcome_RCPRE_t, error) {

	var pr C.E2SM_RC_PRE_ControlOutcome_RCPRE_PR
	choiceC := [8]byte{}
	...
	case *e2sm_rc_pre_v2.E2SmRcPreControlOutcome_ControlOutcomeFormat1:
		pr = C.E2SM_RC_PRE_ControlOutcome_RCPRE_PR_controlOutcome_Format1
	...
	e2SmRcPreControlOutcomeC := C.E2SM_RC_PRE_ControlOutcome_RCPRE_t{
		present: pr,
		choice:  choiceC,
	}
...
func decodeE2SmRcPreControlOutcome(e2SmRcPreControlOutcomeC *C.E2SM_RC_PRE_ControlOutcome_RCPRE_t) (*e2sm_rc_pre_v2.E2SmRcPreControlOutcome, error) {
	...
	case C.E2SM_RC_PRE_ControlOutcome_RCPRE_PR_controlOutcome_Format1:
