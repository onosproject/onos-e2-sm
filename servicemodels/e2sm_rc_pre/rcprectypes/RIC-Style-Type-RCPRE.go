...
func xerEncodeRicStyleType(ricStyleType *e2sm_rc_pre_v2.RicStyleType) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RIC_Style_Type_RCPRE, unsafe.Pointer(ricStyleTypeCP))
	if err != nil {
...
func perEncodeRicStyleType(ricStyleType *e2sm_rc_pre_v2.RicStyleType) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RIC_Style_Type_RCPRE, unsafe.Pointer(ricStyleTypeCP))
	if err != nil {
...
func xerDecodeRicStyleType(bytes []byte) (*e2sm_rc_pre_v2.RicStyleType, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RIC_Style_Type_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicStyleType((*C.RIC_Style_Type_RCPRE_t)(unsafePtr)), nil
}

func perDecodeRicStyleType(bytes []byte) (*e2sm_rc_pre_v2.RicStyleType, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RIC_Style_Type_RCPRE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicStyleType(ricStyleType *e2sm_rc_pre_v2.RicStyleType) *C.RIC_Style_Type_RCPRE_t {
...
func decodeRicStyleType(ricStyleTypeC *C.RIC_Style_Type_RCPRE_t) *e2sm_rc_pre_v2.RicStyleType {
...
func decodeRicStyleTypeBytes(array [8]byte) *e2sm_rc_pre_v2.RicStyleType {
	ricStyleTypeC := (*C.RIC_Style_Type_RCPRE_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
