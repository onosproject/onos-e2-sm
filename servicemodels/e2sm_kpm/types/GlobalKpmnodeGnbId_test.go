...
func TestGlobalKpmnodeGnbID_SetGlobalGnbID(t *testing.T) {
	...
	assert.Equal(t, globalKpmnodeGnbID.GlobalGnbID.GnbID.ID.GetLen(), len, "Test_GlobalKpmnodeGnbID() SetGlobalGnbID BitString lengths mismatch")
}
...
func TestGlobalKpmnodeGnbID_GetGlobalGnbID(t *testing.T) {
	...
	assert.Equal(t, globalKpmnodeGnbID.GetGlobalGnbID().GetGnbID().GetGnbIDChoice().GetID().GetLen(), len, "Test_GlobalKpmnodeGnbID() GetGlobalGnbID BitString lengths mismatch")
}
