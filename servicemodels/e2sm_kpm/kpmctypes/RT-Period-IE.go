...
func newRtPeriodIe(rtPeriodIe e2sm_kpm_ies.RtPeriodIe) (C.RT_Period_IE_t, error) {
	...
	switch rtPeriodIe {
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS10:
		ret = C.RT_Period_IE_ms10
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS20:
		ret = C.RT_Period_IE_ms20
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS32:
		ret = C.RT_Period_IE_ms32
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS40:
		ret = C.RT_Period_IE_ms40
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS60:
		ret = C.RT_Period_IE_ms60
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS64:
		ret = C.RT_Period_IE_ms64
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS70:
		ret = C.RT_Period_IE_ms70
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS80:
		ret = C.RT_Period_IE_ms80
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS128:
		ret = C.RT_Period_IE_ms128
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS160:
		ret = C.RT_Period_IE_ms160
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS256:
		ret = C.RT_Period_IE_ms256
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS320:
		ret = C.RT_Period_IE_ms320
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS512:
		ret = C.RT_Period_IE_ms512
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS640:
		ret = C.RT_Period_IE_ms640
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS1024:
		ret = C.RT_Period_IE_ms1024
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS1280:
		ret = C.RT_Period_IE_ms1280
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS2048:
		ret = C.RT_Period_IE_ms2048
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS2560:
		ret = C.RT_Period_IE_ms2560
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS5120:
		ret = C.RT_Period_IE_ms5120
	case e2sm_kpm_ies.RtPeriodIe_RT_PERIOD_IE_MS10240:
