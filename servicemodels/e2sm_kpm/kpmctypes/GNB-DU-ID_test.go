...
func Test_decodeGnbDuId(t *testing.T) {
	...
	result, err := decodeGnbDuId(gnbDuIdC)
...
func Test_perEncodeDecodeGnbDuId(t *testing.T) {
	...
	assert.Equal(t, gnbDuId, result.Value, "Error between the keyboard and the chair?")
}
