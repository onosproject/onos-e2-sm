...
func (m *E2SmRcPreEventTriggerDefinitionFormat1) validate(all bool) error {
	...
	//
	//case *E2SmRcPreEventTriggerDefinitionFormat1_ReportingPeriodMs:
...
func (m *E2SmRcPreIndicationHeaderFormat1) validate(all bool) error {
	...
	//switch m.XCgi.(type) {
	//
	//case *E2SmRcPreIndicationHeaderFormat1_Cgi:
...
func (m *E2SmRcPreControlHeaderFormat1) validate(all bool) error {
	...
	//switch m.XCgi.(type) {
	//
	//case *E2SmRcPreControlHeaderFormat1_Cgi:
	...
	//
	//case *E2SmRcPreControlHeaderFormat1_RicControlMessagePriority:
