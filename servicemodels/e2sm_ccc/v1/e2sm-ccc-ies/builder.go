...
func (m *RrmPolicyMember) SetSnssai(snssai *e2smcommoniesv1.SNSsai) *RrmPolicyMember {
	m.Snssai = snssai
	return m
}
...
func (m *E2SmCCcControlOutcomeFormat1) SetReceivedTimestamp(receivedTimestamp []byte) *E2SmCCcControlOutcomeFormat1 {
