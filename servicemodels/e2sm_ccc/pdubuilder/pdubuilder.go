...
func CreateConfigurationStructureFailed(ranConfigurationStructureName *e2smcccv1.RanConfigurationStructureName, oldValuesOfAttributes *e2smcccv1.ValuesOfAttributes, requestedValuesOfAttributes *e2smcccv1.ValuesOfAttributes, cause e2smcccv1.OutcomeCause) (*e2smcccv1.ConfigurationStructureFailed, error) {
...
func CreateOutcomeCauseNotSupported() e2smcccv1.OutcomeCause {
	return e2smcccv1.OutcomeCause_OUTCOME_CAUSE_NOT_SUPPORTED
}
func CreateOutcomeCauseNotAvailable() e2smcccv1.OutcomeCause {
	return e2smcccv1.OutcomeCause_OUTCOME_CAUSE_NOT_AVAILABLE
}
func CreateOutcomeCauseIncompatibleState() e2smcccv1.OutcomeCause {
	return e2smcccv1.OutcomeCause_OUTCOME_CAUSE_INCOMPATIBLE_STATE
}
func CreateOutcomeCauseJsonError() e2smcccv1.OutcomeCause {
	return e2smcccv1.OutcomeCause_OUTCOME_CAUSE_JSON_ERROR
}
func CreateOutcomeCauseSemanticError() e2smcccv1.OutcomeCause {
	return e2smcccv1.OutcomeCause_OUTCOME_CAUSE_SEMANTIC_ERROR
}
func CreateOutcomeCauseUnspecified() e2smcccv1.OutcomeCause {
	return e2smcccv1.OutcomeCause_OUTCOME_CAUSE_UNSPECIFIED
}
