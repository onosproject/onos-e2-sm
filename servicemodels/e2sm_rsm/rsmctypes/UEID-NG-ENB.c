...
asn_TYPE_member_t asn_MBR_UEID_NG_ENB_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct UEID_NG_ENB, ng_eNB_CU_UE_W1AP_ID),
	...
	{ ATF_POINTER, 2, offsetof(struct UEID_NG_ENB, m_NG_RAN_UE_XnAP_ID),
	...
	{ ATF_POINTER, 1, offsetof(struct UEID_NG_ENB, globalNgENB_ID),
...
static const int asn_MAP_UEID_NG_ENB_oms_1[] = { 2, 3, 4 };
