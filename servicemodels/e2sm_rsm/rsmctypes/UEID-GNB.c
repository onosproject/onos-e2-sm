...
asn_TYPE_member_t asn_MBR_UEID_GNB_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct UEID_GNB, gNB_CU_UE_F1AP_ID_List),
	...
	{ ATF_POINTER, 4, offsetof(struct UEID_GNB, gNB_CU_CP_UE_E1AP_ID_List),
	...
	{ ATF_POINTER, 3, offsetof(struct UEID_GNB, ran_UEID),
	...
	{ ATF_POINTER, 2, offsetof(struct UEID_GNB, m_NG_RAN_UE_XnAP_ID),
	...
	{ ATF_POINTER, 1, offsetof(struct UEID_GNB, globalGNB_ID),
...
static const int asn_MAP_UEID_GNB_oms_1[] = { 2, 3, 4, 5, 6 };
