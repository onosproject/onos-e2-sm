...
func xerEncodeCellMeasurementObjectItem(cellMeasurementObjectItem *e2sm_kpm_v2.CellMeasurementObjectItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_Cell_Measurement_Object_Item_KPMv2, unsafe.Pointer(cellMeasurementObjectItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeCellMeasurementObjectItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeCellMeasurementObjectItem(cellMeasurementObjectItem *e2sm_kpm_v2.CellMeasurementObjectItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_Cell_Measurement_Object_Item_KPMv2, unsafe.Pointer(cellMeasurementObjectItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeCellMeasurementObjectItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeCellMeasurementObjectItem(bytes []byte) (*e2sm_kpm_v2.CellMeasurementObjectItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_Cell_Measurement_Object_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeCellMeasurementObjectItem((*C.Cell_Measurement_Object_Item_KPMv2_t)(unsafePtr))
}

func perDecodeCellMeasurementObjectItem(bytes []byte) (*e2sm_kpm_v2.CellMeasurementObjectItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_Cell_Measurement_Object_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newCellMeasurementObjectItem(cellMeasurementObjectItem *e2sm_kpm_v2.CellMeasurementObjectItem) (*C.Cell_Measurement_Object_Item_KPMv2_t, error) {
	...
	cellMeasurementObjectItemC := C.Cell_Measurement_Object_Item_KPMv2_t{
...
func decodeCellMeasurementObjectItem(cellMeasurementObjectItemC *C.Cell_Measurement_Object_Item_KPMv2_t) (*e2sm_kpm_v2.CellMeasurementObjectItem, error) {
