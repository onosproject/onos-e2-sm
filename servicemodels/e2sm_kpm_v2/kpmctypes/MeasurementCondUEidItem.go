...
func decodeMeasurementCondUeIDItemBytes(array [8]byte) (*e2sm_kpm_v2.MeasurementCondUeidItem, error) {
	measurementCondUeIDItemC := (*C.MeasurementCondUEidItem_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeMeasurementCondUeIDItem(measurementCondUeIDItemC)
}
