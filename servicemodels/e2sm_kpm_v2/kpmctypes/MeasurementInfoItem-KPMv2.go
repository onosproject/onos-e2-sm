...
func xerEncodeMeasurementInfoItem(measurementInfoItem *e2sm_kpm_v2.MeasurementInfoItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementInfoItem_KPMv2, unsafe.Pointer(measurementInfoItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementInfoItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementInfoItem(measurementInfoItem *e2sm_kpm_v2.MeasurementInfoItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementInfoItem_KPMv2, unsafe.Pointer(measurementInfoItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementInfoItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementInfoItem(bytes []byte) (*e2sm_kpm_v2.MeasurementInfoItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementInfoItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementInfoItem((*C.MeasurementInfoItem_KPMv2_t)(unsafePtr))
}

func perDecodeMeasurementInfoItem(bytes []byte) (*e2sm_kpm_v2.MeasurementInfoItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementInfoItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementInfoItem(measurementInfoItem *e2sm_kpm_v2.MeasurementInfoItem) (*C.MeasurementInfoItem_KPMv2_t, error) {
	...
	measurementInfoItemC := C.MeasurementInfoItem_KPMv2_t{
		measType: *measTypeC,
...
func decodeMeasurementInfoItem(measurementInfoItemC *C.MeasurementInfoItem_KPMv2_t) (*e2sm_kpm_v2.MeasurementInfoItem, error) {
