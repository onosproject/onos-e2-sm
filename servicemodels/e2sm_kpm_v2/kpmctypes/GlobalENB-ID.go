...
func decodeGlobalEnbIDBytes(array [8]byte) (*e2sm_kpm_v2.GlobalEnbId, error) {
	globalEnbIDC := (*C.GlobalENB_ID_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeGlobalEnbID(globalEnbIDC)
}
