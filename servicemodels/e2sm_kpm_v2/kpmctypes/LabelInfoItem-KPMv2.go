...
func xerEncodeLabelInfoItem(labelInfoItem *e2sm_kpm_v2.LabelInfoItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_LabelInfoItem_KPMv2, unsafe.Pointer(labelInfoItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeLabelInfoItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeLabelInfoItem(labelInfoItem *e2sm_kpm_v2.LabelInfoItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_LabelInfoItem_KPMv2, unsafe.Pointer(labelInfoItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeLabelInfoItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeLabelInfoItem(bytes []byte) (*e2sm_kpm_v2.LabelInfoItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_LabelInfoItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeLabelInfoItem((*C.LabelInfoItem_KPMv2_t)(unsafePtr))
}

func perDecodeLabelInfoItem(bytes []byte) (*e2sm_kpm_v2.LabelInfoItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_LabelInfoItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newLabelInfoItem(labelInfoItem *e2sm_kpm_v2.LabelInfoItem) (*C.LabelInfoItem_KPMv2_t, error) {
	...
	labelInfoItemC := C.LabelInfoItem_KPMv2_t{
...
func decodeLabelInfoItem(labelInfoItemC *C.LabelInfoItem_KPMv2_t) (*e2sm_kpm_v2.LabelInfoItem, error) {
