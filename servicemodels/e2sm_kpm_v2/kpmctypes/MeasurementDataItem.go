...
func decodeMeasurementDataItemBytes(array [8]byte) (*e2sm_kpm_v2.MeasurementDataItem, error) {
	measurementDataItemC := (*C.MeasurementDataItem_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeMeasurementDataItem(measurementDataItemC)
}
