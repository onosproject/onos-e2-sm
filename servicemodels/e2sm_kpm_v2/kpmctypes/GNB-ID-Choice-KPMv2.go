...
func xerEncodeGnbIDChoice(gnbIDChoice *e2sm_kpm_v2.GnbIdChoice) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GNB_ID_Choice_KPMv2, unsafe.Pointer(gnbIDChoiceCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGnbIDChoice() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGnbIDChoice(gnbIDChoice *e2sm_kpm_v2.GnbIdChoice) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GNB_ID_Choice_KPMv2, unsafe.Pointer(gnbIDChoiceCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGnbIDChoice() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGnbIDChoice(bytes []byte) (*e2sm_kpm_v2.GnbIdChoice, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GNB_ID_Choice_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGnbIDChoice((*C.GNB_ID_Choice_KPMv2_t)(unsafePtr))
}

func perDecodeGnbIDChoice(bytes []byte) (*e2sm_kpm_v2.GnbIdChoice, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GNB_ID_Choice_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGnbIDChoice(gnbIDChoice *e2sm_kpm_v2.GnbIdChoice) (*C.GNB_ID_Choice_KPMv2_t, error) {

	var pr C.GNB_ID_Choice_KPMv2_PR
	choiceC := [48]byte{}

	switch choice := gnbIDChoice.GetGnbIdChoice().(type) {
	case *e2sm_kpm_v2.GnbIdChoice_GnbId:
		pr = C.GNB_ID_Choice_KPMv2_PR_gnb_ID
	...
	gnbIDChoiceC := C.GNB_ID_Choice_KPMv2_t{
		present: pr,
		choice:  choiceC,
	}
...
func decodeGnbIDChoice(gnbIDchoiceC *C.GNB_ID_Choice_KPMv2_t) (*e2sm_kpm_v2.GnbIdChoice, error) {

	gnbIDchoice := new(e2sm_kpm_v2.GnbIdChoice)

	switch gnbIDchoiceC.present {
	case C.GNB_ID_Choice_KPMv2_PR_gnb_ID:
	...
	case C.GNB_ID_Choice_KPMv2_PR_NOTHING:
