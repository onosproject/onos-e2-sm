...
//#include <stdlib.h>
//#include <assert.h>
//#include "GlobalKPMv2node-eNB-ID.h"
import "C"
...
func xerEncodeGlobalKpmnodeEnbID(globalKpmnodeEnbID *e2sm_kpm_v2.GlobalKpmnodeEnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalKPMv2node_eNB_ID, unsafe.Pointer(globalKpmnodeEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalKpmnodeEnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalKpmnodeEnbID(globalKpmnodeEnbID *e2sm_kpm_v2.GlobalKpmnodeEnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalKPMv2node_eNB_ID, unsafe.Pointer(globalKpmnodeEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalKpmnodeEnbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalKpmnodeEnbID(bytes []byte) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalKPMv2node_eNB_ID)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalKpmnodeEnbID((*C.GlobalKPMv2node_eNB_ID_t)(unsafePtr))
}

func perDecodeGlobalKpmnodeEnbID(bytes []byte) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalKPMv2node_eNB_ID)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalKpmnodeEnbID(globalKpmnodeEnbID *e2sm_kpm_v2.GlobalKpmnodeEnbId) (*C.GlobalKPMv2node_eNB_ID_t, error) {
	...
	globalKpmnodeEnbIDC := C.GlobalKPMv2node_eNB_ID_t{
...
func decodeGlobalKpmnodeEnbID(globalKpmnodeEnbIDC *C.GlobalKPMv2node_eNB_ID_t) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
...
func decodeGlobalKpmnodeEnbIDBytes(array [8]byte) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
	globalKpmnodeEnbIDC := (*C.GlobalKPMv2node_eNB_ID_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
