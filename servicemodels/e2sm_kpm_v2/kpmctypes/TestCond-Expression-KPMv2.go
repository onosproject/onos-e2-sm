...
func xerEncodeTestCondExpression(testCondExpression e2sm_kpm_v2.TestCondExpression) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_TestCond_Expression_KPMv2, unsafe.Pointer(testCondExpressionCP))
	if err != nil {
...
func perEncodeTestCondExpression(testCondExpression e2sm_kpm_v2.TestCondExpression) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_TestCond_Expression_KPMv2, unsafe.Pointer(testCondExpressionCP))
	if err != nil {
...
func xerDecodeTestCondExpression(bytes []byte) (*e2sm_kpm_v2.TestCondExpression, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_TestCond_Expression_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeTestCondExpression((*C.TestCond_Expression_KPMv2_t)(unsafePtr))
}

func perDecodeTestCondExpression(bytes []byte) (*e2sm_kpm_v2.TestCondExpression, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_TestCond_Expression_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func decodeTestCondExpression(testCondExpressionC *C.TestCond_Expression_KPMv2_t) (*e2sm_kpm_v2.TestCondExpression, error) {
