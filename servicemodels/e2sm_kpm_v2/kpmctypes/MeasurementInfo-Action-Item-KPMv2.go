...
func xerEncodeMeasurementInfoActionItem(measurementInfoActionItem *e2sm_kpm_v2.MeasurementInfoActionItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementInfo_Action_Item_KPMv2, unsafe.Pointer(measurementInfoActionItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementInfoActionItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementInfoActionItem(measurementInfoActionItem *e2sm_kpm_v2.MeasurementInfoActionItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementInfo_Action_Item_KPMv2, unsafe.Pointer(measurementInfoActionItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementInfoActionItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementInfoActionItem(bytes []byte) (*e2sm_kpm_v2.MeasurementInfoActionItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementInfo_Action_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementInfoActionItem((*C.MeasurementInfo_Action_Item_KPMv2_t)(unsafePtr))
}

func perDecodeMeasurementInfoActionItem(bytes []byte) (*e2sm_kpm_v2.MeasurementInfoActionItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementInfo_Action_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementInfoActionItem(measurementInfoActionItem *e2sm_kpm_v2.MeasurementInfoActionItem) (*C.MeasurementInfo_Action_Item_KPMv2_t, error) {
	...
	measurementInfoActionItemC := C.MeasurementInfo_Action_Item_KPMv2_t{
		measName: *measNameC,
		//measID:   measIDC,
	}
...
func decodeMeasurementInfoActionItem(measurementInfoActionItemC *C.MeasurementInfo_Action_Item_KPMv2_t) (*e2sm_kpm_v2.MeasurementInfoActionItem, error) {
