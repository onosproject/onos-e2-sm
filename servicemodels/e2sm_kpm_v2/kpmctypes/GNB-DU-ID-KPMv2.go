...
func xerEncodeGnbDuID(gnbDuID *e2sm_kpm_v2.GnbDuId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GNB_DU_ID_KPMv2, unsafe.Pointer(gnbDuIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGnbDuID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGnbDuID(gnbDuID *e2sm_kpm_v2.GnbDuId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GNB_DU_ID_KPMv2, unsafe.Pointer(gnbDuIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGnbDuID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGnbDuID(bytes []byte) (*e2sm_kpm_v2.GnbDuId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GNB_DU_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGnbDuID((*C.GNB_DU_ID_KPMv2_t)(unsafePtr))
}

func perDecodeGnbDuID(bytes []byte) (*e2sm_kpm_v2.GnbDuId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GNB_DU_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGnbDuID(gnbDuID *e2sm_kpm_v2.GnbDuId) (*C.GNB_DU_ID_KPMv2_t, error) {
...
func decodeGnbDuID(gnbDuIDC *C.GNB_DU_ID_KPMv2_t) (*e2sm_kpm_v2.GnbDuId, error) {
