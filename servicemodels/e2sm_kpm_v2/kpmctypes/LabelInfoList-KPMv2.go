...
func xerEncodeLabelInfoList(labelInfoList *e2sm_kpm_v2.LabelInfoList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_LabelInfoList_KPMv2, unsafe.Pointer(labelInfoListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeLabelInfoList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeLabelInfoList(labelInfoList *e2sm_kpm_v2.LabelInfoList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_LabelInfoList_KPMv2, unsafe.Pointer(labelInfoListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeLabelInfoList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeLabelInfoList(bytes []byte) (*e2sm_kpm_v2.LabelInfoList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_LabelInfoList_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeLabelInfoList((*C.LabelInfoList_KPMv2_t)(unsafePtr))
}

func perDecodeLabelInfoList(bytes []byte) (*e2sm_kpm_v2.LabelInfoList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_LabelInfoList_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newLabelInfoList(labelInfoList *e2sm_kpm_v2.LabelInfoList) (*C.LabelInfoList_KPMv2_t, error) {

	labelInfoListC := new(C.LabelInfoList_KPMv2_t)
...
func decodeLabelInfoList(labelInfoListC *C.LabelInfoList_KPMv2_t) (*e2sm_kpm_v2.LabelInfoList, error) {
	...
	for i := 0; i < ieCount; i++ {
		...
		ieC := *(**C.LabelInfoItem_KPMv2_t)(unsafe.Pointer(uintptr(unsafe.Pointer(labelInfoListC.list.array)) + offset))
