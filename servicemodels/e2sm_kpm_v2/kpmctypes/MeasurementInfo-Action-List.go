...
func xerEncodeMeasurementInfoActionList(measurementInfoActionList *e2sm_kpm_v2.MeasurementInfoActionList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementInfo_Action_List, unsafe.Pointer(measurementInfoActionListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementInfoActionList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementInfoActionList(measurementInfoActionList *e2sm_kpm_v2.MeasurementInfoActionList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementInfo_Action_List, unsafe.Pointer(measurementInfoActionListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementInfoActionList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementInfoActionList(bytes []byte) (*e2sm_kpm_v2.MeasurementInfoActionList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementInfo_Action_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementInfoActionList(measurementInfoActionList *e2sm_kpm_v2.MeasurementInfoActionList) (*C.MeasurementInfo_Action_List_t, error) {
	...
	measurementInfoActionListC := new(C.MeasurementInfo_Action_List_t)
