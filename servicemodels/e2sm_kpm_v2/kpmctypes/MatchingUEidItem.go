...
func decodeMatchingUeIDItemBytes(array [8]byte) (*e2sm_kpm_v2.MatchingUeidItem, error) {
	matchingUeIDItemC := (*C.MatchingUEidItem_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeMatchingUeIDItem(matchingUeIDItemC)
}
