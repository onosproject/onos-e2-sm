...
func xerEncodeMeasurementInfoList(measurementInfoList *e2sm_kpm_v2.MeasurementInfoList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementInfoList_KPMv2, unsafe.Pointer(measurementInfoListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementInfoList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementInfoList(measurementInfoList *e2sm_kpm_v2.MeasurementInfoList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementInfoList_KPMv2, unsafe.Pointer(measurementInfoListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementInfoList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementInfoList(bytes []byte) (*e2sm_kpm_v2.MeasurementInfoList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementInfoList_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementInfoList((*C.MeasurementInfoList_KPMv2_t)(unsafePtr))
}

func perDecodeMeasurementInfoList(bytes []byte) (*e2sm_kpm_v2.MeasurementInfoList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementInfoList_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementInfoList(measurementInfoList *e2sm_kpm_v2.MeasurementInfoList) (*C.MeasurementInfoList_KPMv2_t, error) {

	measurementInfoListC := new(C.MeasurementInfoList_KPMv2_t)
...
func decodeMeasurementInfoList(measurementInfoListC *C.MeasurementInfoList_KPMv2_t) (*e2sm_kpm_v2.MeasurementInfoList, error) {
	...
	for i := 0; i < ieCount; i++ {
		...
		ieC := *(**C.MeasurementInfoItem_KPMv2_t)(unsafe.Pointer(uintptr(unsafe.Pointer(measurementInfoListC.list.array)) + offset))
