...
func xerEncodeE2SmKpmIndicationMessageFormat1(e2SmKpmIndicationMessageFormat1 *e2sm_kpm_v2.E2SmKpmIndicationMessageFormat1) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_KPMv2_IndicationMessage_Format1, unsafe.Pointer(e2SmKpmIndicationMessageFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2SmKpmIndicationMessageFormat1() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2SmKpmIndicationMessageFormat1(e2SmKpmIndicationMessageFormat1 *e2sm_kpm_v2.E2SmKpmIndicationMessageFormat1) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_KPMv2_IndicationMessage_Format1, unsafe.Pointer(e2SmKpmIndicationMessageFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2SmKpmIndicationMessageFormat1() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2SmKpmIndicationMessageFormat1(bytes []byte) (*e2sm_kpm_v2.E2SmKpmIndicationMessageFormat1, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_KPMv2_IndicationMessage_Format1)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmKpmIndicationMessageFormat1((*C.E2SM_KPMv2_IndicationMessage_Format1_t)(unsafePtr))
}

func perDecodeE2SmKpmIndicationMessageFormat1(bytes []byte) (*e2sm_kpm_v2.E2SmKpmIndicationMessageFormat1, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_KPMv2_IndicationMessage_Format1)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmKpmIndicationMessageFormat1(e2SmKpmIndicationMessageFormat1 *e2sm_kpm_v2.E2SmKpmIndicationMessageFormat1) (*C.E2SM_KPMv2_IndicationMessage_Format1_t, error) {
...
func decodeE2SmKpmIndicationMessageFormat1(e2SmKpmIndicationMessageFormat1C *C.E2SM_KPMv2_IndicationMessage_Format1_t) (*e2sm_kpm_v2.E2SmKpmIndicationMessageFormat1, error) {
...
func decodeE2SmKpmIndicationMessageFormat1Bytes(array [8]byte) (*e2sm_kpm_v2.E2SmKpmIndicationMessageFormat1, error) {
	e2SmKpmIndicationMessageFormat1C := (*C.E2SM_KPMv2_IndicationMessage_Format1_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
