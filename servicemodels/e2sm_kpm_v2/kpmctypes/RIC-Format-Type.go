...
func newRicFormatType(ricFormatType *e2sm_kpm_v2.RicFormatType) (*C.RIC_Format_Type_t, error) {
...
func decodeRicFormatType(ricFormatTypeC *C.RIC_Format_Type_t) (*e2sm_kpm_v2.RicFormatType, error) {
