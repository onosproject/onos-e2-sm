...
func decodeE2SmKpmIndicationMessageBytes(array [8]byte) (*e2sm_kpm_v2.E2SmKpmIndicationMessage, error) { //ToDo - Check addressing correct structure in Protobuf
	e2SmKpmIndicationMessageC := (*C.E2SM_KPM_IndicationMessage_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeE2SmKpmIndicationMessage(e2SmKpmIndicationMessageC)
}
