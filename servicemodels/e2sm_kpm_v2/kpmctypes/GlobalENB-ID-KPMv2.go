...
func xerEncodeGlobalEnbID(globalEnbID *e2sm_kpm_v2.GlobalEnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalENB_ID_KPMv2, unsafe.Pointer(globalEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalEnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalEnbID(globalEnbID *e2sm_kpm_v2.GlobalEnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalENB_ID_KPMv2, unsafe.Pointer(globalEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalEnbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalEnbID(bytes []byte) (*e2sm_kpm_v2.GlobalEnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalENB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalEnbID((*C.GlobalENB_ID_KPMv2_t)(unsafePtr))
}

func perDecodeGlobalEnbID(bytes []byte) (*e2sm_kpm_v2.GlobalEnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalENB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalEnbID(globalEnbID *e2sm_kpm_v2.GlobalEnbId) (*C.GlobalENB_ID_KPMv2_t, error) {
	...
	globalEnbIDC := C.GlobalENB_ID_KPMv2_t{
...
func decodeGlobalEnbID(globalEnbIDC *C.GlobalENB_ID_KPMv2_t) (*e2sm_kpm_v2.GlobalEnbId, error) {
