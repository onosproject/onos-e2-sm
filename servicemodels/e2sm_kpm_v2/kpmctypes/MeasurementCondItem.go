...
func decodeMeasurementCondItemBytes(array [8]byte) (*e2sm_kpm_v2.MeasurementCondItem, error) {
	measurementCondItemC := (*C.MeasurementCondItem_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeMeasurementCondItem(measurementCondItemC)
}
