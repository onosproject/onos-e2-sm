...
func XerEncodeE2SmKpmActionDefinition(e2SmKpmActionDefinition *e2sm_kpm_v2.E2SmKpmActionDefinition) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_KPMv2_ActionDefinition, unsafe.Pointer(e2SmKpmActionDefinitionCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2SmKpmActionDefinition() %s", err.Error())
	}
	return bytes, nil
...
func PerEncodeE2SmKpmActionDefinition(e2SmKpmActionDefinition *e2sm_kpm_v2.E2SmKpmActionDefinition) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_KPMv2_ActionDefinition, unsafe.Pointer(e2SmKpmActionDefinitionCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2SmKpmActionDefinition() %s", err.Error())
	}
	return bytes, nil
...
func XerDecodeE2SmKpmActionDefinition(bytes []byte) (*e2sm_kpm_v2.E2SmKpmActionDefinition, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_KPMv2_ActionDefinition)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmKpmActionDefinition((*C.E2SM_KPMv2_ActionDefinition_t)(unsafePtr))
}

func PerDecodeE2SmKpmActionDefinition(bytes []byte) (*e2sm_kpm_v2.E2SmKpmActionDefinition, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_KPMv2_ActionDefinition)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmKpmActionDefinition(e2SmKpmActionDefinition *e2sm_kpm_v2.E2SmKpmActionDefinition) (*C.E2SM_KPMv2_ActionDefinition_t, error) {
	...
	var pr C.E2SM_KPMv2_ActionDefinition__actionDefinition_formats_PR
	choiceC := [8]byte{}
	...
	case *e2sm_kpm_v2.E2SmKpmActionDefinition_ActionDefinitionFormat1:
		pr = C.E2SM_KPMv2_ActionDefinition__actionDefinition_formats_PR_actionDefinition_Format1
	...
	case *e2sm_kpm_v2.E2SmKpmActionDefinition_ActionDefinitionFormat2:
		pr = C.E2SM_KPMv2_ActionDefinition__actionDefinition_formats_PR_actionDefinition_Format2
	...
	case *e2sm_kpm_v2.E2SmKpmActionDefinition_ActionDefinitionFormat3:
		pr = C.E2SM_KPMv2_ActionDefinition__actionDefinition_formats_PR_actionDefinition_Format3
	...
	e2SmKpmActionDefinitionFormatC := C.struct_E2SM_KPMv2_ActionDefinition__actionDefinition_formats{
		present: pr,
		choice:  choiceC,
	}

	e2SmKpmActionDefinitionC := C.E2SM_KPMv2_ActionDefinition_t{
...
func decodeE2SmKpmActionDefinition(e2SmKpmActionDefinitionC *C.E2SM_KPMv2_ActionDefinition_t) (*e2sm_kpm_v2.E2SmKpmActionDefinition, error) {
	...
	case C.E2SM_KPMv2_ActionDefinition__actionDefinition_formats_PR_actionDefinition_Format1:
	...
	case C.E2SM_KPMv2_ActionDefinition__actionDefinition_formats_PR_actionDefinition_Format2:
	...
	case C.E2SM_KPMv2_ActionDefinition__actionDefinition_formats_PR_actionDefinition_Format3:
