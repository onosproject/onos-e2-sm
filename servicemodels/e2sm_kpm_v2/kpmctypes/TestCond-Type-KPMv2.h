...
/* TestCond_Type__gBR */
typedef long	 TestCond_Type_KPMv2__gBR_t;
...
/* TestCond_Type__aMBR */
typedef long	 TestCond_Type_KPMv2__aMBR_t;
...
typedef long	 TestCond_Type_KPMv2__isStat_t;
...
typedef long	 TestCond_Type_KPMv2__isCatM_t;
...
/* TestCond_Type__rSRP */
typedef long	 TestCond_Type_KPMv2__rSRP_t;
...
/* TestCond_Type__rSRQ */
typedef long	 TestCond_Type_KPMv2__rSRQ_t;

/* TestCond-Type-KPMv2 */
typedef struct TestCond_Type_KPMv2 {
	TestCond_Type_KPMv2_PR present;
	union TestCond_Type_KPMv2_u {
		TestCond_Type_KPMv2__gBR_t	 gBR;
		TestCond_Type_KPMv2__aMBR_t	 aMBR;
		TestCond_Type_KPMv2__isStat_t	 isStat;
		TestCond_Type_KPMv2__isCatM_t	 isCatM;
		TestCond_Type_KPMv2__rSRP_t	 rSRP;
		TestCond_Type_KPMv2__rSRQ_t	 rSRQ;
		/*
