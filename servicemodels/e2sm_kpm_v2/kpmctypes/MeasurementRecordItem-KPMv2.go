...
func xerEncodeMeasurementRecordItem(measurementRecordItem *e2sm_kpm_v2.MeasurementRecordItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementRecordItem_KPMv2, unsafe.Pointer(measurementRecordItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementRecordItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementRecordItem(measurementRecordItem *e2sm_kpm_v2.MeasurementRecordItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementRecordItem_KPMv2, unsafe.Pointer(measurementRecordItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementRecordItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementRecordItem(bytes []byte) (*e2sm_kpm_v2.MeasurementRecordItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementRecordItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementRecordItem((*C.MeasurementRecordItem_KPMv2_t)(unsafePtr))
}

func perDecodeMeasurementRecordItem(bytes []byte) (*e2sm_kpm_v2.MeasurementRecordItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementRecordItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementRecordItem(measurementRecordItem *e2sm_kpm_v2.MeasurementRecordItem) (*C.MeasurementRecordItem_KPMv2_t, error) {
	...
	measurementRecordItemC := C.MeasurementRecordItem_KPMv2_t{
		present: pr,
		choice:  choiceC,
	}
...
func decodeMeasurementRecordItem(measurementRecordItemC *C.MeasurementRecordItem_KPMv2_t) (*e2sm_kpm_v2.MeasurementRecordItem, error) {
	...
	case C.MeasurementRecordItem_KPMv2_PR_integer:
	...
	case C.MeasurementRecordItem_KPMv2_PR_real:
	...
	case C.MeasurementRecordItem_KPMv2_PR_noValue:
		null := decodeNull()
		measurementRecordItem.MeasurementRecordItem = &e2sm_kpm_v2.MeasurementRecordItem_NoValue{
			NoValue: null,
		}
	case C.MeasurementRecordItem_KPMv2_PR_NOTHING:
