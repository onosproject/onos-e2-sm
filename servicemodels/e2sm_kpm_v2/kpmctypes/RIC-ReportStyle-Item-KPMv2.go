...
func xerEncodeRicReportStyleItem(ricReportStyleItem *e2sm_kpm_v2.RicReportStyleItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RIC_ReportStyle_Item_KPMv2, unsafe.Pointer(ricReportStyleItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeRicReportStyleItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeRicReportStyleItem(ricReportStyleItem *e2sm_kpm_v2.RicReportStyleItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RIC_ReportStyle_Item_KPMv2, unsafe.Pointer(ricReportStyleItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeRicReportStyleItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeRicReportStyleItem(bytes []byte) (*e2sm_kpm_v2.RicReportStyleItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RIC_ReportStyle_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicReportStyleItem((*C.RIC_ReportStyle_Item_KPMv2_t)(unsafePtr))
}

func perDecodeRicReportStyleItem(bytes []byte) (*e2sm_kpm_v2.RicReportStyleItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RIC_ReportStyle_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicReportStyleItem(ricReportStyleItem *e2sm_kpm_v2.RicReportStyleItem) (*C.RIC_ReportStyle_Item_KPMv2_t, error) {
	...
	ricReportStyleItemC := C.RIC_ReportStyle_Item_KPMv2_t{
...
func decodeRicReportStyleItem(ricReportStyleItemC *C.RIC_ReportStyle_Item_KPMv2_t) (*e2sm_kpm_v2.RicReportStyleItem, error) {
