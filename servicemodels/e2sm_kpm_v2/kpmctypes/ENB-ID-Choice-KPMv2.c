...
asn_per_constraints_t asn_PER_type_ENB_ID_Choice_KPMv2_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  2 }	/* (0..2,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_ENB_ID_Choice_KPMv2_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ENB_ID_Choice_KPMv2, choice.enb_ID_macro),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ENB_ID_Choice_KPMv2, choice.enb_ID_shortmacro),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ENB_ID_Choice_KPMv2, choice.enb_ID_longmacro),
...
static const asn_TYPE_tag2member_t asn_MAP_ENB_ID_Choice_KPMv2_tag2el_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_ENB_ID_Choice_KPMv2_specs_1 = {
	sizeof(struct ENB_ID_Choice_KPMv2),
	offsetof(struct ENB_ID_Choice_KPMv2, _asn_ctx),
	offsetof(struct ENB_ID_Choice_KPMv2, present),
	sizeof(((struct ENB_ID_Choice_KPMv2 *)0)->present),
	asn_MAP_ENB_ID_Choice_KPMv2_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0,
	3	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_ENB_ID_Choice_KPMv2 = {
	"ENB-ID-Choice-KPMv2",
	"ENB-ID-Choice-KPMv2",
	&asn_OP_CHOICE,
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ENB_ID_Choice_KPMv2_constr_1, CHOICE_constraint },
	asn_MBR_ENB_ID_Choice_KPMv2_1,
	3,	/* Elements count */
	&asn_SPC_ENB_ID_Choice_KPMv2_specs_1	/* Additional specs */
};
