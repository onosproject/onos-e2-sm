...
func newE2SmKpmEventTriggerDefinition(e2SmKpmEventTriggerDefinition *e2sm_kpm_v2.E2SmKpmEventTriggerDefinition) (*C.E2SM_KPM_EventTriggerDefinition_t, error) {

	var pr C.E2SM_KPM_EventTriggerDefinition__eventDefinition_formats_PR
	choiceC := [8]byte{}
	...
	case *e2sm_kpm_v2.E2SmKpmEventTriggerDefinition_EventDefinitionFormat1:
		pr = C.E2SM_KPM_EventTriggerDefinition__eventDefinition_formats_PR_eventDefinition_Format1
	...
	e2SmKpmEventTriggerDefinitionFormatC := C.struct_E2SM_KPM_EventTriggerDefinition__eventDefinition_formats{
		present: pr,
		choice:  choiceC,
	}
...
func decodeE2SmKpmEventTriggerDefinition(e2SmKpmEventTriggerDefinitionC *C.E2SM_KPM_EventTriggerDefinition_t) (*e2sm_kpm_v2.E2SmKpmEventTriggerDefinition, error) {
	...
	case C.E2SM_KPM_EventTriggerDefinition__eventDefinition_formats_PR_eventDefinition_Format1:
...
func decodeE2SmKpmEventTriggerDefinitionBytes(array [8]byte) (*e2sm_kpm_v2.E2SmKpmEventTriggerDefinition, error) {
	e2SmKpmEventTriggerDefinitionC := (*C.E2SM_KPM_EventTriggerDefinition_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeE2SmKpmEventTriggerDefinition(e2SmKpmEventTriggerDefinitionC)
}
