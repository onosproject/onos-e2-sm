...
func xerEncodeMeasurementRecord(measurementRecord *e2sm_kpm_v2.MeasurementRecord) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementRecord, unsafe.Pointer(measurementRecordCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementRecord() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementRecord(measurementRecord *e2sm_kpm_v2.MeasurementRecord) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementRecord, unsafe.Pointer(measurementRecordCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementRecord() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementRecord(bytes []byte) (*e2sm_kpm_v2.MeasurementRecord, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementRecord)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementRecord((*C.MeasurementRecord_t)(unsafePtr))
}

func perDecodeMeasurementRecord(bytes []byte) (*e2sm_kpm_v2.MeasurementRecord, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementRecord)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementRecord(measurementRecord *e2sm_kpm_v2.MeasurementRecord) (*C.MeasurementRecord_t, error) {

	measurementRecordC := new(C.MeasurementRecord_t)
