...
func newRicStyleType(ricStyleType *e2sm_kpm_v2.RicStyleType) (*C.RIC_Style_Type_t, error) {
...
func decodeRicStyleType(ricStyleTypeC *C.RIC_Style_Type_t) (*e2sm_kpm_v2.RicStyleType, error) {
...
func decodeRicStyleTypeBytes(array [8]byte) (*e2sm_kpm_v2.RicStyleType, error) {
