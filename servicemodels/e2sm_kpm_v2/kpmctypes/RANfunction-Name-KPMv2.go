...
func xerEncodeRanfunctionName(ranfunctionName *e2sm_kpm_v2.RanfunctionName) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RANfunction_Name_KPMv2, unsafe.Pointer(ranfunctionNameCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeRanfunctionName() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeRanfunctionName(ranfunctionName *e2sm_kpm_v2.RanfunctionName) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RANfunction_Name_KPMv2, unsafe.Pointer(ranfunctionNameCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeRanfunctionName() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeRanfunctionName(bytes []byte) (*e2sm_kpm_v2.RanfunctionName, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RANfunction_Name_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRanfunctionName((*C.RANfunction_Name_KPMv2_t)(unsafePtr))
}

func perDecodeRanfunctionName(bytes []byte) (*e2sm_kpm_v2.RanfunctionName, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RANfunction_Name_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRanfunctionName(ranfunctionName *e2sm_kpm_v2.RanfunctionName) (*C.RANfunction_Name_KPMv2_t, error) {
	...
	ranfunctionNameC := C.RANfunction_Name_KPMv2_t{
...
func decodeRanfunctionName(ranfunctionNameC *C.RANfunction_Name_KPMv2_t) (*e2sm_kpm_v2.RanfunctionName, error) {
