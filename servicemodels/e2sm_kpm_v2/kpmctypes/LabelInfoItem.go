...
func decodeLabelInfoItemBytes(array [8]byte) (*e2sm_kpm_v2.LabelInfoItem, error) {
	labelInfoItemC := (*C.LabelInfoItem_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeLabelInfoItem(labelInfoItemC)
}
