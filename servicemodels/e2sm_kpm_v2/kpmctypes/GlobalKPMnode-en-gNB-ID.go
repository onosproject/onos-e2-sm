...
func xerEncodeGlobalKpmnodeEnGnbID(globalKpmnodeEnGnbID *e2sm_kpm_v2.GlobalKpmnodeEnGnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalKPMnode_en_gNB_ID, unsafe.Pointer(globalKpmnodeEnGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalKpmnodeEnGnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalKpmnodeEnGnbID(globalKpmnodeEnGnbID *e2sm_kpm_v2.GlobalKpmnodeEnGnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalKPMnode_en_gNB_ID, unsafe.Pointer(globalKpmnodeEnGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalKpmnodeEnGnbID() %s", err.Error())
	}
	return bytes, nil
...
func perDecodeGlobalKpmnodeEnGnbID(bytes []byte) (*e2sm_kpm_v2.GlobalKpmnodeEnGnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalKPMnode_en_gNB_ID)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalKpmnodeEnGnbID(globalKpmnodeEnGnbID *e2sm_kpm_v2.GlobalKpmnodeEnGnbId) (*C.GlobalKPMnode_en_gNB_ID_t, error) {
	...
	gNbCuUpIDC, err := newGnbCuUpID(globalKpmnodeEnGnbID.GNbCuUpId)
	if err != nil {
		return nil, fmt.Errorf("newGnbCuUpID() %s", err.Error())
	}

	gNbDuIDC, err := newGnbDuID(globalKpmnodeEnGnbID.GNbDuId)
	if err != nil {
...
func decodeGlobalKpmnodeEnGnbIDBytes(array [8]byte) (*e2sm_kpm_v2.GlobalKpmnodeEnGnbId, error) {
	globalKpmnodeEnGnbIDC := (*C.GlobalKPMnode_en_gNB_ID_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
