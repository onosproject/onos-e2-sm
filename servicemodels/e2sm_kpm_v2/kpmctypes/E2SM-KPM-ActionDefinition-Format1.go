...
func xerEncodeE2SmKpmActionDefinitionFormat1(e2SmKpmActionDefinitionFormat1 *e2sm_kpm_v2.E2SmKpmActionDefinitionFormat1) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_KPM_ActionDefinition_Format1, unsafe.Pointer(e2SmKpmActionDefinitionFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2SmKpmActionDefinitionFormat1() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2SmKpmActionDefinitionFormat1(e2SmKpmActionDefinitionFormat1 *e2sm_kpm_v2.E2SmKpmActionDefinitionFormat1) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_KPM_ActionDefinition_Format1, unsafe.Pointer(e2SmKpmActionDefinitionFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2SmKpmActionDefinitionFormat1() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2SmKpmActionDefinitionFormat1(bytes []byte) (*e2sm_kpm_v2.E2SmKpmActionDefinitionFormat1, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_KPM_ActionDefinition_Format1)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmKpmActionDefinitionFormat1((*C.E2SM_KPM_ActionDefinition_Format1_t)(unsafePtr))
}

//func perDecodeE2SmKpmActionDefinitionFormat1(bytes []byte) (*e2sm_kpm_v2.E2SmKpmActionDefinitionFormat1, error) {
//	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_KPM_ActionDefinition_Format1)
//	if err != nil {
//		return nil, err
//	}
//	if unsafePtr == nil {
...
func newE2SmKpmActionDefinitionFormat1(e2SmKpmActionDefinitionFormat1 *e2sm_kpm_v2.E2SmKpmActionDefinitionFormat1) (*C.E2SM_KPM_ActionDefinition_Format1_t, error) {
...
func decodeE2SmKpmActionDefinitionFormat1Bytes(array [8]byte) (*e2sm_kpm_v2.E2SmKpmActionDefinitionFormat1, error) {
	e2SmKpmActionDefinitionFormat1C := (*C.E2SM_KPM_ActionDefinition_Format1_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
