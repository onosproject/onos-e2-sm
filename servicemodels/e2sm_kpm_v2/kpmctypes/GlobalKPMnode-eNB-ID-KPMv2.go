...
func xerEncodeGlobalKpmnodeEnbID(globalKpmnodeEnbID *e2sm_kpm_v2.GlobalKpmnodeEnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalKPMnode_eNB_ID_KPMv2, unsafe.Pointer(globalKpmnodeEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalKpmnodeEnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalKpmnodeEnbID(globalKpmnodeEnbID *e2sm_kpm_v2.GlobalKpmnodeEnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalKPMnode_eNB_ID_KPMv2, unsafe.Pointer(globalKpmnodeEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalKpmnodeEnbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalKpmnodeEnbID(bytes []byte) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalKPMnode_eNB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalKpmnodeEnbID((*C.GlobalKPMnode_eNB_ID_KPMv2_t)(unsafePtr))
}

func perDecodeGlobalKpmnodeEnbID(bytes []byte) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalKPMnode_eNB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalKpmnodeEnbID(globalKpmnodeEnbID *e2sm_kpm_v2.GlobalKpmnodeEnbId) (*C.GlobalKPMnode_eNB_ID_KPMv2_t, error) {
	...
	globalKpmnodeEnbIDC := C.GlobalKPMnode_eNB_ID_KPMv2_t{
...
func decodeGlobalKpmnodeEnbID(globalKpmnodeEnbIDC *C.GlobalKPMnode_eNB_ID_KPMv2_t) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
...
func decodeGlobalKpmnodeEnbIDBytes(array [8]byte) (*e2sm_kpm_v2.GlobalKpmnodeEnbId, error) {
	globalKpmnodeEnbIDC := (*C.GlobalKPMnode_eNB_ID_KPMv2_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
