...
func xerEncodeGlobalgNbID(globalgNbID *e2sm_kpm_v2.GlobalgNbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalgNB_ID_KPMv2, unsafe.Pointer(globalgNbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalgNbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalgNbID(globalgNbID *e2sm_kpm_v2.GlobalgNbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalgNB_ID_KPMv2, unsafe.Pointer(globalgNbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalgNbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalgNbID(bytes []byte) (*e2sm_kpm_v2.GlobalgNbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalgNB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalgNbID((*C.GlobalgNB_ID_KPMv2_t)(unsafePtr))
}

func perDecodeGlobalgNbID(bytes []byte) (*e2sm_kpm_v2.GlobalgNbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalgNB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalgNbID(globalgNbID *e2sm_kpm_v2.GlobalgNbId) (*C.GlobalgNB_ID_KPMv2_t, error) {
	...
	globalgNbIDC := C.GlobalgNB_ID_KPMv2_t{
		plmn_id: *plmnIDC,
		gnb_id:  *gnbIDC,
	}
...
func decodeGlobalgNbID(globalgNbIDC *C.GlobalgNB_ID_KPMv2_t) (*e2sm_kpm_v2.GlobalgNbId, error) {
