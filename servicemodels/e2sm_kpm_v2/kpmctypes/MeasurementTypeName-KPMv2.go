...
func xerEncodeMeasurementTypeName(measurementTypeName *e2sm_kpm_v2.MeasurementTypeName) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementTypeName_KPMv2, unsafe.Pointer(measurementTypeNameCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementTypeName() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementTypeName(measurementTypeName *e2sm_kpm_v2.MeasurementTypeName) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementTypeName_KPMv2, unsafe.Pointer(measurementTypeNameCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementTypeName() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementTypeName(bytes []byte) (*e2sm_kpm_v2.MeasurementTypeName, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementTypeName_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementTypeName((*C.MeasurementTypeName_KPMv2_t)(unsafePtr))
}

func perDecodeMeasurementTypeName(bytes []byte) (*e2sm_kpm_v2.MeasurementTypeName, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementTypeName_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementTypeName(measurementTypeName *e2sm_kpm_v2.MeasurementTypeName) (*C.MeasurementTypeName_KPMv2_t, error) {
...
func decodeMeasurementTypeName(measurementTypeNameC *C.MeasurementTypeName_KPMv2_t) (*e2sm_kpm_v2.MeasurementTypeName, error) {
...
func decodeMeasurementTypeNameBytes(array [16]byte) (*e2sm_kpm_v2.MeasurementTypeName, error) {
	measurementTypeNameC := C.MeasurementTypeName_KPMv2_t{
