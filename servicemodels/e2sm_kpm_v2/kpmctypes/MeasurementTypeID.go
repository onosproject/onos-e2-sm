...
func xerEncodeMeasurementTypeID(measurementTypeID *e2sm_kpm_v2.MeasurementTypeId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementTypeID, unsafe.Pointer(measurementTypeIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementTypeId() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementTypeID(measurementTypeID *e2sm_kpm_v2.MeasurementTypeId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementTypeID, unsafe.Pointer(measurementTypeIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementTypeId() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementTypeID(bytes []byte) (*e2sm_kpm_v2.MeasurementTypeId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementTypeID)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementTypeID((*C.MeasurementTypeID_t)(unsafePtr))
}

func perDecodeMeasurementTypeID(bytes []byte) (*e2sm_kpm_v2.MeasurementTypeId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementTypeID)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementTypeID(measurementTypeID *e2sm_kpm_v2.MeasurementTypeId) (*C.MeasurementTypeID_t, error) {
...
func decodeMeasurementTypeID(measurementTypeIDC *C.MeasurementTypeID_t) (*e2sm_kpm_v2.MeasurementTypeId, error) {
