...
func XerEncodeE2SmKpmIndicationMessage(e2SmKpmIndicationMessage *e2sm_kpm_v2.E2SmKpmIndicationMessage) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_KPMv2_IndicationMessage, unsafe.Pointer(e2SmKpmIndicationMessageCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2SmKpmIndicationMessage() %s", err.Error())
	}
	return bytes, nil
...
func PerEncodeE2SmKpmIndicationMessage(e2SmKpmIndicationMessage *e2sm_kpm_v2.E2SmKpmIndicationMessage) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_KPMv2_IndicationMessage, unsafe.Pointer(e2SmKpmIndicationMessageCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2SmKpmIndicationMessage() %s", err.Error())
	}
	return bytes, nil
...
func XerDecodeE2SmKpmIndicationMessage(bytes []byte) (*e2sm_kpm_v2.E2SmKpmIndicationMessage, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_KPMv2_IndicationMessage)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmKpmIndicationMessage((*C.E2SM_KPMv2_IndicationMessage_t)(unsafePtr))
}

func PerDecodeE2SmKpmIndicationMessage(bytes []byte) (*e2sm_kpm_v2.E2SmKpmIndicationMessage, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_KPMv2_IndicationMessage)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmKpmIndicationMessage(e2SmKpmIndicationMessage *e2sm_kpm_v2.E2SmKpmIndicationMessage) (*C.E2SM_KPMv2_IndicationMessage_t, error) {

	var pr C.E2SM_KPMv2_IndicationMessage__indicationMessage_formats_PR
	choiceC := [8]byte{}
	...
	case *e2sm_kpm_v2.E2SmKpmIndicationMessage_IndicationMessageFormat1:
		pr = C.E2SM_KPMv2_IndicationMessage__indicationMessage_formats_PR_indicationMessage_Format1
	...
	case *e2sm_kpm_v2.E2SmKpmIndicationMessage_IndicationMessageFormat2:
		pr = C.E2SM_KPMv2_IndicationMessage__indicationMessage_formats_PR_indicationMessage_Format2
	...
	e2SmKpmIndicationMessageFormatC := C.struct_E2SM_KPMv2_IndicationMessage__indicationMessage_formats{
		present: pr,
		choice:  choiceC,
	}

	e2SmKpmIndicationMessageC := C.E2SM_KPMv2_IndicationMessage_t{
...
func decodeE2SmKpmIndicationMessage(e2SmKpmIndicationMessageC *C.E2SM_KPMv2_IndicationMessage_t) (*e2sm_kpm_v2.E2SmKpmIndicationMessage, error) {
	...
	case C.E2SM_KPMv2_IndicationMessage__indicationMessage_formats_PR_indicationMessage_Format1:
	...
	case C.E2SM_KPMv2_IndicationMessage__indicationMessage_formats_PR_indicationMessage_Format2:
