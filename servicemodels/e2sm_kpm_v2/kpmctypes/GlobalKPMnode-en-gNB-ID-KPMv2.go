...
func xerEncodeGlobalKpmnodeEnGnbID(globalKpmnodeEnGnbID *e2sm_kpm_v2.GlobalKpmnodeEnGnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalKPMnode_en_gNB_ID_KPMv2, unsafe.Pointer(globalKpmnodeEnGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalKpmnodeEnGnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalKpmnodeEnGnbID(globalKpmnodeEnGnbID *e2sm_kpm_v2.GlobalKpmnodeEnGnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalKPMnode_en_gNB_ID_KPMv2, unsafe.Pointer(globalKpmnodeEnGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalKpmnodeEnGnbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalKpmnodeEnGnbID(bytes []byte) (*e2sm_kpm_v2.GlobalKpmnodeEnGnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalKPMnode_en_gNB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalKpmnodeEnGnbID((*C.GlobalKPMnode_en_gNB_ID_KPMv2_t)(unsafePtr))
}

func perDecodeGlobalKpmnodeEnGnbID(bytes []byte) (*e2sm_kpm_v2.GlobalKpmnodeEnGnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalKPMnode_en_gNB_ID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalKpmnodeEnGnbID(globalKpmnodeEnGnbID *e2sm_kpm_v2.GlobalKpmnodeEnGnbId) (*C.GlobalKPMnode_en_gNB_ID_KPMv2_t, error) {
	...
	globalKpmnodeEnGnbIDC := C.GlobalKPMnode_en_gNB_ID_KPMv2_t{
...
func decodeGlobalKpmnodeEnGnbID(globalKpmnodeEnGnbIDC *C.GlobalKPMnode_en_gNB_ID_KPMv2_t) (*e2sm_kpm_v2.GlobalKpmnodeEnGnbId, error) {
...
func decodeGlobalKpmnodeEnGnbIDBytes(array [8]byte) (*e2sm_kpm_v2.GlobalKpmnodeEnGnbId, error) {
	globalKpmnodeEnGnbIDC := (*C.GlobalKPMnode_en_gNB_ID_KPMv2_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
