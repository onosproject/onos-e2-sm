...
func xerEncodeE2SmKpmActionDefinitionFormat2(e2SmKpmActionDefinitionFormat2 *e2sm_kpm_v2.E2SmKpmActionDefinitionFormat2) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_KPMv2_ActionDefinition_Format2, unsafe.Pointer(e2SmKpmActionDefinitionFormat2CP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2SmKpmActionDefinitionFormat2() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2SmKpmActionDefinitionFormat2(e2SmKpmActionDefinitionFormat2 *e2sm_kpm_v2.E2SmKpmActionDefinitionFormat2) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_KPMv2_ActionDefinition_Format2, unsafe.Pointer(e2SmKpmActionDefinitionFormat2CP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2SmKpmActionDefinitionFormat2() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2SmKpmActionDefinitionFormat2(bytes []byte) (*e2sm_kpm_v2.E2SmKpmActionDefinitionFormat2, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_KPMv2_ActionDefinition_Format2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmKpmActionDefinitionFormat2((*C.E2SM_KPMv2_ActionDefinition_Format2_t)(unsafePtr))
}

func perDecodeE2SmKpmActionDefinitionFormat2(bytes []byte) (*e2sm_kpm_v2.E2SmKpmActionDefinitionFormat2, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_KPMv2_ActionDefinition_Format2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2SmKpmActionDefinitionFormat2(e2SmKpmActionDefinitionFormat2 *e2sm_kpm_v2.E2SmKpmActionDefinitionFormat2) (*C.E2SM_KPMv2_ActionDefinition_Format2_t, error) {
	...
	e2SmKpmActionDefinitionFormat2C := C.E2SM_KPMv2_ActionDefinition_Format2_t{
		ueID:          *ueIDC,
...
func decodeE2SmKpmActionDefinitionFormat2(e2SmKpmActionDefinitionFormat2C *C.E2SM_KPMv2_ActionDefinition_Format2_t) (*e2sm_kpm_v2.E2SmKpmActionDefinitionFormat2, error) {
...
func decodeE2SmKpmActionDefinitionFormat2Bytes(array [8]byte) (*e2sm_kpm_v2.E2SmKpmActionDefinitionFormat2, error) {
	e2SmKpmActionDefinitionFormat2C := (*C.E2SM_KPMv2_ActionDefinition_Format2_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
