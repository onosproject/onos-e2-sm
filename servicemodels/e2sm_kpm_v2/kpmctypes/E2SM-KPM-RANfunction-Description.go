...
func decodeE2SmKpmRanfunctionDescriptionBytes(array [8]byte) (*e2sm_kpm_v2.E2SmKpmRanfunctionDescription, error) {
	e2SmKpmRanfunctionDescriptionC := (*C.E2SM_KPM_RANfunction_Description_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeE2SmKpmRanfunctionDescription(e2SmKpmRanfunctionDescriptionC)
}
