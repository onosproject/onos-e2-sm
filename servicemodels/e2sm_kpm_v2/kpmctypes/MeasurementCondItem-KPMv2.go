...
func xerEncodeMeasurementCondItem(measurementCondItem *e2sm_kpm_v2.MeasurementCondItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementCondItem_KPMv2, unsafe.Pointer(measurementCondItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementCondItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementCondItem(measurementCondItem *e2sm_kpm_v2.MeasurementCondItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementCondItem_KPMv2, unsafe.Pointer(measurementCondItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementCondItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementCondItem(bytes []byte) (*e2sm_kpm_v2.MeasurementCondItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementCondItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementCondItem((*C.MeasurementCondItem_KPMv2_t)(unsafePtr))
}

func perDecodeMeasurementCondItem(bytes []byte) (*e2sm_kpm_v2.MeasurementCondItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementCondItem_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementCondItem(measurementCondItem *e2sm_kpm_v2.MeasurementCondItem) (*C.MeasurementCondItem_KPMv2_t, error) {
	...
	measurementCondItemC := C.MeasurementCondItem_KPMv2_t{
		measType:     *measTypeC,
...
func decodeMeasurementCondItem(measurementCondItemC *C.MeasurementCondItem_KPMv2_t) (*e2sm_kpm_v2.MeasurementCondItem, error) {
