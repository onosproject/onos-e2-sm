...
func xerEncodeE2SmKpmEventTriggerDefinitionFormat1(e2SmKpmEventTriggerDefinitionFormat1 *e2sm_kpm_v2.E2SmKpmEventTriggerDefinitionFormat1) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2SM_KPMv2_EventTriggerDefinition_Format1, unsafe.Pointer(e2SmKpmEventTriggerDefinitionFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2SmKpmEventTriggerDefinitionFormat1() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2SmKpmEventTriggerDefinitionFormat1(e2SmKpmEventTriggerDefinitionFormat1 *e2sm_kpm_v2.E2SmKpmEventTriggerDefinitionFormat1) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2SM_KPMv2_EventTriggerDefinition_Format1, unsafe.Pointer(e2SmKpmEventTriggerDefinitionFormat1CP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2SmKpmEventTriggerDefinitionFormat1() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2SmKpmEventTriggerDefinitionFormat1(bytes []byte) (*e2sm_kpm_v2.E2SmKpmEventTriggerDefinitionFormat1, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2SM_KPMv2_EventTriggerDefinition_Format1)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2SmKpmEventTriggerDefinitionFormat1((*C.E2SM_KPMv2_EventTriggerDefinition_Format1_t)(unsafePtr))
}

func perDecodeE2SmKpmEventTriggerDefinitionFormat1(bytes []byte) (*e2sm_kpm_v2.E2SmKpmEventTriggerDefinitionFormat1, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2SM_KPMv2_EventTriggerDefinition_Format1)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func decodeE2SmKpmEventTriggerDefinitionFormat1Bytes(array [8]byte) (*e2sm_kpm_v2.E2SmKpmEventTriggerDefinitionFormat1, error) {
	e2SmKpmEventTriggerDefinitionFormat1C := (*C.E2SM_KPMv2_EventTriggerDefinition_Format1_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
