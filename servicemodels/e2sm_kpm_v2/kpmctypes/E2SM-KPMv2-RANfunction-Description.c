...
static asn_SET_OF_specifics_t asn_SPC_ric_KPM_Node_List_specs_3 = {
	sizeof(struct E2SM_KPMv2_RANfunction_Description__ric_KPM_Node_List),
	offsetof(struct E2SM_KPMv2_RANfunction_Description__ric_KPM_Node_List, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_ric_KPM_Node_List_3 = {
	...
	{ 0, &asn_PER_type_ric_KPM_Node_List_constr_3, SEQUENCE_OF_constraint },
...
static asn_SET_OF_specifics_t asn_SPC_ric_EventTriggerStyle_List_specs_5 = {
	sizeof(struct E2SM_KPMv2_RANfunction_Description__ric_EventTriggerStyle_List),
	offsetof(struct E2SM_KPMv2_RANfunction_Description__ric_EventTriggerStyle_List, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ric_EventTriggerStyle_List_5 = {
	...
	{ 0, &asn_PER_type_ric_EventTriggerStyle_List_constr_5, SEQUENCE_OF_constraint },
...
static asn_SET_OF_specifics_t asn_SPC_ric_ReportStyle_List_specs_7 = {
	sizeof(struct E2SM_KPMv2_RANfunction_Description__ric_ReportStyle_List),
	offsetof(struct E2SM_KPMv2_RANfunction_Description__ric_ReportStyle_List, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ric_ReportStyle_List_7 = {
	...
	{ 0, &asn_PER_type_ric_ReportStyle_List_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_ric_ReportStyle_List_7,
	1,	/* Single element */
	&asn_SPC_ric_ReportStyle_List_specs_7	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_E2SM_KPMv2_RANfunction_Description_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct E2SM_KPMv2_RANfunction_Description, ric_KPM_Node_List),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ric_KPM_Node_List_3,
		0,
		{ 0, &asn_PER_memb_ric_KPM_Node_List_constr_3,  memb_ric_KPM_Node_List_constraint_1 },
		0, 0, /* No default value */
		"ric-KPM-Node-List"
		},
	{ ATF_POINTER, 2, offsetof(struct E2SM_KPMv2_RANfunction_Description, ric_EventTriggerStyle_List),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ric_EventTriggerStyle_List_5,
		0,
		{ 0, &asn_PER_memb_ric_EventTriggerStyle_List_constr_5,  memb_ric_EventTriggerStyle_List_constraint_1 },
		0, 0, /* No default value */
		"ric-EventTriggerStyle-List"
		},
	{ ATF_POINTER, 1, offsetof(struct E2SM_KPMv2_RANfunction_Description, ric_ReportStyle_List),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ric_ReportStyle_List_7,
		0,
		{ 0, &asn_PER_memb_ric_ReportStyle_List_constr_7,  memb_ric_ReportStyle_List_constraint_1 },
		0, 0, /* No default value */
		"ric-ReportStyle-List"
		},
};
static const int asn_MAP_E2SM_KPMv2_RANfunction_Description_oms_1[] = { 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_E2SM_KPMv2_RANfunction_Description_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E2SM_KPMv2_RANfunction_Description_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_E2SM_KPMv2_RANfunction_Description_specs_1 = {
	sizeof(struct E2SM_KPMv2_RANfunction_Description),
	offsetof(struct E2SM_KPMv2_RANfunction_Description, _asn_ctx),
	asn_MAP_E2SM_KPMv2_RANfunction_Description_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_E2SM_KPMv2_RANfunction_Description_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_E2SM_KPMv2_RANfunction_Description = {
	"E2SM-KPMv2-RANfunction-Description",
	"E2SM-KPMv2-RANfunction-Description",
	&asn_OP_SEQUENCE,
	asn_DEF_E2SM_KPMv2_RANfunction_Description_tags_1,
	sizeof(asn_DEF_E2SM_KPMv2_RANfunction_Description_tags_1)
		/sizeof(asn_DEF_E2SM_KPMv2_RANfunction_Description_tags_1[0]), /* 1 */
	asn_DEF_E2SM_KPMv2_RANfunction_Description_tags_1,	/* Same as above */
	sizeof(asn_DEF_E2SM_KPMv2_RANfunction_Description_tags_1)
		/sizeof(asn_DEF_E2SM_KPMv2_RANfunction_Description_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_E2SM_KPMv2_RANfunction_Description_1,
	4,	/* Elements count */
	&asn_SPC_E2SM_KPMv2_RANfunction_Description_specs_1	/* Additional specs */
};
