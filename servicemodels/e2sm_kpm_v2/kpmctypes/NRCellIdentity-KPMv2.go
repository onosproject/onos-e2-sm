...
func xerEncodeNrcellIdentity(nrcellIdentity *e2sm_kpm_v2.NrcellIdentity) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_NRCellIdentity_KPMv2, unsafe.Pointer(nrcellIdentityCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeNrcellIdentity() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeNrcellIdentity(nrcellIdentity *e2sm_kpm_v2.NrcellIdentity) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_NRCellIdentity_KPMv2, unsafe.Pointer(nrcellIdentityCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeNrcellIdentity() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeNrcellIdentity(bytes []byte) (*e2sm_kpm_v2.NrcellIdentity, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_NRCellIdentity_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeNrcellIdentity((*C.NRCellIdentity_KPMv2_t)(unsafePtr))
}

func perDecodeNrcellIdentity(bytes []byte) (*e2sm_kpm_v2.NrcellIdentity, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_NRCellIdentity_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newNrcellIdentity(nrcellIdentity *e2sm_kpm_v2.NrcellIdentity) (*C.NRCellIdentity_KPMv2_t, error) {
...
func decodeNrcellIdentity(nrcellIdentityC *C.NRCellIdentity_KPMv2_t) (*e2sm_kpm_v2.NrcellIdentity, error) {
