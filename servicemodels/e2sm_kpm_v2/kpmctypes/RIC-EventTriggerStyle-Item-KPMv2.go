...
func xerEncodeRicEventTriggerStyleItem(ricEventTriggerStyleItem *e2sm_kpm_v2.RicEventTriggerStyleItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RIC_EventTriggerStyle_Item_KPMv2, unsafe.Pointer(ricEventTriggerStyleItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeRicEventTriggerStyleItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeRicEventTriggerStyleItem(ricEventTriggerStyleItem *e2sm_kpm_v2.RicEventTriggerStyleItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RIC_EventTriggerStyle_Item_KPMv2, unsafe.Pointer(ricEventTriggerStyleItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeRicEventTriggerStyleItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeRicEventTriggerStyleItem(bytes []byte) (*e2sm_kpm_v2.RicEventTriggerStyleItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RIC_EventTriggerStyle_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicEventTriggerStyleItem((*C.RIC_EventTriggerStyle_Item_KPMv2_t)(unsafePtr))
}

func perDecodeRicEventTriggerStyleItem(bytes []byte) (*e2sm_kpm_v2.RicEventTriggerStyleItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RIC_EventTriggerStyle_Item_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicEventTriggerStyleItem(ricEventTriggerStyleItem *e2sm_kpm_v2.RicEventTriggerStyleItem) (*C.RIC_EventTriggerStyle_Item_KPMv2_t, error) {
	...
	ricEventTriggerStyleItemC := C.RIC_EventTriggerStyle_Item_KPMv2_t{
...
func decodeRicEventTriggerStyleItem(ricEventTriggerStyleItemC *C.RIC_EventTriggerStyle_Item_KPMv2_t) (*e2sm_kpm_v2.RicEventTriggerStyleItem, error) {
