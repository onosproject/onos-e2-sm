...
int
RIC_Style_Type_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_RIC_Style_Type_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_RIC_Style_Type = {
	...
	sizeof(asn_DEF_RIC_Style_Type_tags_1)
		/sizeof(asn_DEF_RIC_Style_Type_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_RIC_Style_Type_constr_1, RIC_Style_Type_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
