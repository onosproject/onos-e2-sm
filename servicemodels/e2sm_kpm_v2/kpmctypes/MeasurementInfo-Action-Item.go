...
func decodeMeasurementInfoActionItemBytes(array [8]byte) (*e2sm_kpm_v2.MeasurementInfoActionItem, error) {
	measurementInfoActionItemC := (*C.MeasurementInfo_Action_Item_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))

	return decodeMeasurementInfoActionItem(measurementInfoActionItemC)
}
