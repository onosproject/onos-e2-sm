...
func xerEncodeMeasurementCondList(measurementCondList *e2sm_kpm_v2.MeasurementCondList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_MeasurementCondList_KPMv2, unsafe.Pointer(measurementCondListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeMeasurementCondList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeMeasurementCondList(measurementCondList *e2sm_kpm_v2.MeasurementCondList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_MeasurementCondList_KPMv2, unsafe.Pointer(measurementCondListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeMeasurementCondList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeMeasurementCondList(bytes []byte) (*e2sm_kpm_v2.MeasurementCondList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_MeasurementCondList_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeMeasurementCondList((*C.MeasurementCondList_KPMv2_t)(unsafePtr))
}

func perDecodeMeasurementCondList(bytes []byte) (*e2sm_kpm_v2.MeasurementCondList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_MeasurementCondList_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newMeasurementCondList(measurementCondList *e2sm_kpm_v2.MeasurementCondList) (*C.MeasurementCondList_KPMv2_t, error) {

	measurementCondListC := new(C.MeasurementCondList_KPMv2_t)
...
func decodeMeasurementCondList(measurementCondListC *C.MeasurementCondList_KPMv2_t) (*e2sm_kpm_v2.MeasurementCondList, error) {
	...
	for i := 0; i < ieCount; i++ {
		...
		ieC := *(**C.MeasurementCondItem_KPMv2_t)(unsafe.Pointer(uintptr(unsafe.Pointer(measurementCondListC.list.array)) + offset))
