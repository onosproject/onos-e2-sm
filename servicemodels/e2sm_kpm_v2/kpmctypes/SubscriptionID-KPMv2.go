...
func xerEncodeSubscriptionID(subscriptionID *e2sm_kpm_v2.SubscriptionId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_SubscriptionID_KPMv2, unsafe.Pointer(subscriptionIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeSubscriptionId() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeSubscriptionID(subscriptionID *e2sm_kpm_v2.SubscriptionId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_SubscriptionID_KPMv2, unsafe.Pointer(subscriptionIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeSubscriptionId() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeSubscriptionID(bytes []byte) (*e2sm_kpm_v2.SubscriptionId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_SubscriptionID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeSubscriptionID((*C.SubscriptionID_KPMv2_t)(unsafePtr))
}

func perDecodeSubscriptionID(bytes []byte) (*e2sm_kpm_v2.SubscriptionId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_SubscriptionID_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newSubscriptionID(subscriptionID *e2sm_kpm_v2.SubscriptionId) (*C.SubscriptionID_KPMv2_t, error) {
...
func decodeSubscriptionID(subscriptionIDC *C.SubscriptionID_KPMv2_t) (*e2sm_kpm_v2.SubscriptionId, error) {
