...
func xerEncodeTestCondType(testCondType *e2sm_kpm_v2.TestCondType) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_TestCond_Type_KPMv2, unsafe.Pointer(testCondTypeCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeTestCondType() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeTestCondType(testCondType *e2sm_kpm_v2.TestCondType) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_TestCond_Type_KPMv2, unsafe.Pointer(testCondTypeCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeTestCondType() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeTestCondType(bytes []byte) (*e2sm_kpm_v2.TestCondType, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_TestCond_Type_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeTestCondType((*C.TestCond_Type_KPMv2_t)(unsafePtr))
}

func perDecodeTestCondType(bytes []byte) (*e2sm_kpm_v2.TestCondType, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_TestCond_Type_KPMv2)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newTestCondType(testCondType *e2sm_kpm_v2.TestCondType) (*C.TestCond_Type_KPMv2_t, error) {

	var pr C.TestCond_Type_KPMv2_PR
	choiceC := [8]byte{}

	switch choice := testCondType.TestCondType.(type) {
	case *e2sm_kpm_v2.TestCondType_GBr:
		pr = C.TestCond_Type_KPMv2_PR_gBR

		var gbrC C.TestCond_Type_KPMv2__gBR_t
		switch choice.GBr {
		case e2sm_kpm_v2.GBR_GBR_TRUE:
			gbrC = C.TestCond_Type_KPMv2__gBR_true
		default:
	...
	case *e2sm_kpm_v2.TestCondType_AMbr:
		pr = C.TestCond_Type_KPMv2_PR_aMBR

		var ambrC C.TestCond_Type_KPMv2__aMBR_t
		switch choice.AMbr {
		case e2sm_kpm_v2.AMBR_AMBR_TRUE:
			ambrC = C.TestCond_Type_KPMv2__aMBR_true
		default:
	...
	case *e2sm_kpm_v2.TestCondType_IsStat:
		pr = C.TestCond_Type_KPMv2_PR_isStat

		var isStatC C.TestCond_Type_KPMv2__isStat_t
		switch choice.IsStat {
		case e2sm_kpm_v2.ISSTAT_ISSTAT_TRUE:
			isStatC = C.TestCond_Type_KPMv2__aMBR_true
		default:
	...
	case *e2sm_kpm_v2.TestCondType_IsCatM:
		pr = C.TestCond_Type_KPMv2_PR_isCatM

		var isCatMC C.TestCond_Type_KPMv2__isCatM_t
		switch choice.IsCatM {
		case e2sm_kpm_v2.ISCATM_ISCATM_TRUE:
			isCatMC = C.TestCond_Type_KPMv2__isCatM_true
		default:
	...
	case *e2sm_kpm_v2.TestCondType_RSrp:
		pr = C.TestCond_Type_KPMv2_PR_rSRP

		var rsrpC C.TestCond_Type_KPMv2__rSRP_t
		switch choice.RSrp {
		case e2sm_kpm_v2.RSRP_RSRP_TRUE:
			rsrpC = C.TestCond_Type_KPMv2__rSRP_true
		default:
	...
	case *e2sm_kpm_v2.TestCondType_RSrq:
		pr = C.TestCond_Type_KPMv2_PR_rSRQ

		var rsrqC C.TestCond_Type_KPMv2__rSRQ_t
		switch choice.RSrq {
		case e2sm_kpm_v2.RSRQ_RSRQ_TRUE:
			rsrqC = C.TestCond_Type_KPMv2__rSRQ_true
		default:
	...
	testCondTypeC := C.TestCond_Type_KPMv2_t{
		present: pr,
		choice:  choiceC,
	}
...
func decodeTestCondType(testCondTypeC *C.TestCond_Type_KPMv2_t) (*e2sm_kpm_v2.TestCondType, error) {

	testCondType := new(e2sm_kpm_v2.TestCondType)

	switch testCondTypeC.present {
	case C.TestCond_Type_KPMv2_PR_gBR:
